...
// Blog types (Phase 83)
export type DbBlogCategory = Database["public"]["Tables"]["blog_categories"]["Row"];
export type DbBlogCategoryInsert = Database["public"]["Tables"]["blog_categories"]["Insert"];
export type DbBlogCategoryUpdate = Database["public"]["Tables"]["blog_categories"]["Update"];

export type DbBlogPost = Database["public"]["Tables"]["blog_posts"]["Row"];
export type DbBlogPostInsert = Database["public"]["Tables"]["blog_posts"]["Insert"];
export type DbBlogPostUpdate = Database["public"]["Tables"]["blog_posts"]["Update"];

export type DbBlogPostCategory = Database["public"]["Tables"]["blog_post_categories"]["Row"];
export type DbBlogPostCategoryInsert = Database["public"]["Tables"]["blog_post_categories"]["Insert"];
export type DbBlogPostCategoryUpdate = Database["public"]["Tables"]["blog_post_categories"]["Update"];
