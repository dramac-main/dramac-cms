...
// Domain Reselling Settings — Overview Page
// Moved from /dashboard/settings/domains/ to keep domain settings within the domain module
...
async function DomainSettingsContent() {
  ...
  const settingsCards = [
    ...
    },
    {
      ...
      icon: CreditCard,
      href: "/dashboard/domains/settings/billing",
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="outline" asChild>
              <Link href="/dashboard/domains/settings/pricing">Edit Pricing</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
