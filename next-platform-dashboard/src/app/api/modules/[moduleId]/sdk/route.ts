...
export async function GET(
  ...
  try {
    ...
    const siteModuleInstallationId = request.nextUrl.searchParams.get(
      "siteModuleInstallationId",
    );
    const language = request.nextUrl.searchParams.get(
      "language",
    ...
    const sdkGenerator = new SDKGenerator(moduleName, baseUrl, entities);
