 ...
 * 
 * Client component that uses useSearchParams - wrapped in Suspense by parent page
 */
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <FAQItem 
              ...
              answer="We offer a 30-day money-back guarantee for new subscriptions. If you're not satisfied, contact support for a full refund within the first 30 days."
            />
            <FAQItem 
              question="What payment methods do you accept?"
              answer="We accept all major credit cards (Visa, Mastercard, Amex, Discover) and PayPal through our payment processor, Paddle."
            />
          </div>
        </div>
