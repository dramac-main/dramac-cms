 ...
 *
 * Campaign list with create button for portal clients.
...
export default async function PortalCampaignsPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      <Suspense fallback={<CampaignListSkeleton />}>
        <CampaignList siteId={siteId} filters={{}} />
      </Suspense>
    </PortalProvider>
  );
}
