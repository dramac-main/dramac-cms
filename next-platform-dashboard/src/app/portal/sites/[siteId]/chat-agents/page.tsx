/**
 * Portal Chat Agents Management
 *
 * Mounts the existing AgentsPageWrapper with portal access verification.
...
import { getAgentPerformance } from "@/modules/live-chat/actions/agent-actions";
...
async function AgentsContent({ siteId }: { siteId: string }) {
  // Self-heal: ensure admin agent exists
...
export default async function PortalChatAgentsPage({ params }: PageProps) {
