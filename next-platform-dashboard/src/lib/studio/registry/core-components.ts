...
const layoutComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A vertical or horizontal stack that arranges children with consistent spacing",
      canModify: [
        "direction",
        "spacing",
        "align",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A full-featured flexbox container with wrapping and alignment control",
      canModify: [
        "direction",
        "wrap",
        "gap",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A utility wrapper for adding spacing, background, and borders around content",
      canModify: [
        "padding",
        "margin",
        "backgroundColor",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A container that maintains a fixed aspect ratio regardless of content",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A full-viewport scroll-snap container for immersive storytelling",
      canModify: [
        "showProgress",
        "progressPosition",
        "progressColor",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A container that sticks to a position while the user scrolls",
      canModify: [
        "stickyPosition",
        "stickyWidth",
        "stickyOffset",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "Wraps content with entrance animations triggered on scroll or hover",
      canModify: ["entrance"],
    },
  }),
  ...
  defineComponent({
    ...
    ai: {
      description:
        "An SVG shape divider for smooth visual transitions between sections",
      canModify: [
        "shape",
        "color",
        "height",
...
const typographyComponents: ComponentDefinition[] = [
  defineComponent({
    type: "Heading",
    label: "Heading",
    description: "Heading text (H1-H6) with full typography controls, gradient, and CSS variable type scale",
    category: "typography",
    icon: "Heading",
    ...
    fields: {
      ...
      fontSize: {
        type: "text",
        label: "Font Size (CSS)",
        placeholder: "3rem or clamp(2rem, 5vw, 4rem)",
      },
      fontWeight: {
        type: "select",
        label: "Font Weight",
      ...
      gradient: { type: "toggle", label: "Enable Gradient", defaultValue: false },
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Typography",
        icon: "ALargeSmall",
        fields: ["fontFamily", "fontSize", "fontWeight", "lineHeight", "letterSpacing", "textTransform", "fontStyle", "textDecoration"],
      ...
      },
      {
        ...
        label: "Effects",
        icon: "Sparkles",
        fields: ["gradient", "gradientFrom", "gradientTo", "gradientDirection", "textShadow"],
        defaultExpanded: false,
      },
      {
        id: "layout",
    ...
    ai: {
      description: "A heading element with full typography controls, gradient text, and CSS variable type scale integration",
      canModify: ["text", "level", "align", "color", "fontFamily", "fontSize", "fontWeight", "gradient", "gradientFrom", "gradientTo", "textTransform"],
      suggestions: ["Make it more exciting", "Shorten it", "Add an emoji", "Apply a gradient"],
    },
  }),
...
const buttonComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    label: "Button",
    description:
      "Premium button with 60+ customization options including gradients, animations, badges, and tooltips",
    category: "buttons",
    icon: "MousePointer",
    render: ButtonRender,
    fields: {
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Gradient",
        icon: "sunset",
        fields: ["gradientFrom", "gradientTo", "gradientDirection"],
        defaultExpanded: false,
      },
      {
        id: "border",
        label: "Border & Radius",
        icon: "square",
        fields: ["borderRadius", "borderWidth"],
        defaultExpanded: false,
      },
      {
        id: "shadow",
        label: "Shadow & Glow",
        icon: "sun",
        fields: ["shadow", "hoverShadow", "glowOnHover", "glowColor"],
        defaultExpanded: false,
      },
      {
        id: "sizing",
        label: "Sizing",
        icon: "maximize",
        fields: ["fullWidth", "fullWidthMobile", "minWidth"],
        defaultExpanded: false,
      },
      {
        id: "typography",
        label: "Typography",
        icon: "type",
        fields: ["fontWeight", "textTransform", "letterSpacing"],
        defaultExpanded: false,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "zap",
        fields: ["hoverEffect", "transitionDuration"],
        defaultExpanded: false,
      },
      {
        id: "states",
        label: "States",
        icon: "toggle-left",
        fields: ["disabled", "loading", "loadingText", "loadingAnimation"],
        defaultExpanded: false,
      },
      {
        id: "icon",
        label: "Icon Styling",
        icon: "image",
        fields: ["iconSize", "iconGap", "iconColor"],
        defaultExpanded: false,
      },
      {
        id: "badge",
      ...
      },
      {
        ...
        label: "Tooltip",
        icon: "message-circle",
        fields: ["tooltip", "tooltipPosition"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
        label: "Accessibility",
        icon: "eye",
        fields: ["ariaLabel", "focusRingColor"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A premium button with extensive customization including gradients, animations, badges, tooltips, and loading states",
      canModify: [
        "label",
        "variant",
        "size",
...
const mediaComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    label: "Image",
    description:
      "Premium image with 50+ options including filters, overlays, frames, badges, and animations",
    category: "media",
    icon: "Image",
    render: ImageRender,
    fields: {
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Sizing",
        icon: "maximize",
        fields: ["width", "maxWidth", "maxHeight", "aspectRatio"],
        defaultExpanded: false,
      },
      {
        id: "fit",
        label: "Fit & Position",
        icon: "move",
        fields: ["objectFit", "objectPosition"],
        defaultExpanded: false,
      },
      {
        id: "border",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "zap",
        fields: ["animateOnLoad", "animationType", "animationDuration"],
        defaultExpanded: false,
      },
      {
        id: "frame",
        label: "Frame",
        icon: "frame",
        fields: ["showFrame", "frameColor", "framePadding", "frameStyle"],
        defaultExpanded: false,
      },
      {
        id: "badge",
        label: "Badge",
        icon: "tag",
        fields: ["showBadge", "badgeText", "badgeColor", "badgePosition"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A premium image with filters, overlays, frames, badges, and hover effects",
      canModify: [
        "alt",
        "width",
        "aspectRatio",
  ...
  defineComponent({
    ...
    label: "Video",
    description:
      "Premium video player with 50+ options including YouTube/Vimeo support, custom play buttons, and overlays",
    category: "media",
    icon: "Video",
    render: VideoRender,
    fields: {
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Sizing",
        icon: "maximize",
        fields: ["width", "maxWidth", "aspectRatio", "customAspect"],
        defaultExpanded: false,
      },
      {
        id: "playback",
      ...
      },
      {
        ...
        label: "Loading",
        icon: "loader",
        fields: ["loading", "showLoadingSpinner", "loadingSpinnerColor"],
        defaultExpanded: false,
      },
      {
        id: "caption",
        label: "Caption",
        icon: "type",
        fields: ["caption", "captionAlign", "captionColor", "captionSize"],
        defaultExpanded: false,
      },
      {
        id: "container",
      ...
      },
      {
        ...
        label: "Title Bar",
        icon: "menu",
        fields: ["showTitleBar", "title", "titleBarColor", "titleBarTextColor"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    ai: {
      description:
        "A premium video player supporting YouTube, Vimeo, and native video with custom play buttons and overlays",
  ...
  defineComponent({
    ...
    label: "Map",
    description:
      "Premium embedded map with 40+ options including markers, styles, directions, and info windows",
    category: "media",
    icon: "MapPin",
    render: MapRender,
    fields: {
      ...
      markers: {
        ...
        itemFields: {
          ...
          color: { type: "color", label: "Color", defaultValue: "#ef4444" },
        },
      },
      autoTheme: {
        type: "toggle",
        label: "Auto Dark Mode",
        description: "Automatically match map theme to site dark mode",
      },
      ...
      showLoadingPlaceholder: {
        type: "toggle",
        label: "Show Loading Placeholder",
        defaultValue: true,
      },
      placeholderColor: {
        type: "color",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Sizing",
        icon: "maximize",
        fields: ["height", "width", "maxWidth", "aspectRatio"],
        defaultExpanded: false,
      },
      {
        id: "appearance",
      ...
      },
      {
        ...
        label: "Marker",
        icon: "map-pin",
        fields: ["showMarker", "markerColor", "markerLabel"],
        defaultExpanded: false,
      },
      {
        id: "controls",
      ...
      },
      {
        ...
        label: "Interaction",
        icon: "mouse-pointer",
        fields: ["allowScrollZoom", "allowDragging"],
        defaultExpanded: false,
      },
      {
        id: "style",
        label: "Style",
        icon: "droplet",
        fields: ["mapStyle", "grayscale", "saturation"],
        defaultExpanded: false,
      },
      {
        id: "infoWindow",
        label: "Info Window",
        icon: "info",
        fields: ["showInfoWindow", "infoWindowTitle"],
        defaultExpanded: false,
      },
      {
        id: "directions",
      ...
      },
      {
        ...
        label: "Loading",
        icon: "loader",
        fields: ["loading", "showLoadingPlaceholder", "placeholderColor"],
        defaultExpanded: false,
      },
      {
        id: "caption",
        label: "Caption",
        icon: "type",
        fields: ["caption", "captionAlign", "captionColor"],
        defaultExpanded: false,
      },
      {
        id: "container",
    ...
    ai: {
      description:
        "A premium embedded map with markers, styles, directions links, and comprehensive customization",
      canModify: [
        "address",
        "zoom",
        "height",
  ...
  defineComponent({
    ...
    category: "media",
    icon: "Columns",
    render: BeforeAfterRender,
    fields: {
      beforeImage: { type: "image", label: "Before Image" },
      afterImage: { type: "image", label: "After Image" },
      beforeLabel: { type: "text", label: "Before Label", defaultValue: "Before" },
      afterLabel: { type: "text", label: "After Label", defaultValue: "After" },
      initialPosition: { type: "number", label: "Initial Position (%)", min: 0, max: 100, defaultValue: 50 },
      orientation: { type: "select", label: "Orientation", options: [{ label: "Horizontal", value: "horizontal" }, { label: "Vertical", value: "vertical" }], defaultValue: "horizontal" },
      handleStyle: { type: "select", label: "Handle Style", options: [{ label: "Line", value: "line" }, { label: "Circle", value: "circle" }, { label: "Arrows", value: "arrows" }], defaultValue: "arrows" },
      handleColor: { type: "color", label: "Handle Colour" },
      handleSize: { type: "select", label: "Handle Size", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }], defaultValue: "md" },
      showLabels: { type: "toggle", label: "Show Labels", defaultValue: true },
      labelPosition: { type: "select", label: "Label Position", options: [{ label: "Top", value: "top" }, { label: "Bottom", value: "bottom" }, { label: "Overlay", value: "overlay" }], defaultValue: "overlay" },
      aspectRatio: { type: "select", label: "Aspect Ratio", options: [{ label: "Square", value: "square" }, { label: "Video (16:9)", value: "video" }, { label: "Portrait", value: "portrait" }, { label: "Wide (21:9)", value: "wide" }, { label: "Auto", value: "auto" }], defaultValue: "video" },
      borderRadius: { type: "select", label: "Border Radius", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }], defaultValue: "lg" },
      caption: { type: "text", label: "Caption" },
      captionColor: { type: "color", label: "Caption Colour" },
      labelBackgroundColor: { type: "color", label: "Label Background" },
      labelTextColor: { type: "color", label: "Label Text Colour" },
      ariaLabel: { type: "text", label: "ARIA Label" },
    },
    defaultProps: {
      beforeLabel: "Before",
    ...
    ai: {
      description: "A draggable image comparison slider for showing before/after transformations — renovations, cosmetic work, photo editing, web design",
      canModify: ["beforeImage", "afterImage", "beforeLabel", "afterLabel", "handleStyle", "aspectRatio", "borderRadius"],
      suggestions: ["Add before/after images", "Change handle style", "Adjust aspect ratio"],
    },
  }),
  ...
  defineComponent({
    ...
    render: IconRender,
    fields: {
      name: { type: "text", label: "Icon Name (Lucide)", defaultValue: "Zap" },
      size: { type: "select", label: "Size", options: [{ label: "XS", value: "xs" }, { label: "SM", value: "sm" }, { label: "MD", value: "md" }, { label: "LG", value: "lg" }, { label: "XL", value: "xl" }, { label: "2XL", value: "2xl" }, { label: "3XL", value: "3xl" }], defaultValue: "md" },
      color: { type: "color", label: "Icon Colour" },
      backgroundColor: { type: "color", label: "Background Colour" },
      backgroundShape: { type: "select", label: "Background Shape", options: [{ label: "None", value: "none" }, { label: "Circle", value: "circle" }, { label: "Rounded", value: "rounded" }, { label: "Square", value: "square" }], defaultValue: "none" },
      backgroundPadding: { type: "select", label: "Background Padding", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }], defaultValue: "md" },
      strokeWidth: { type: "number", label: "Stroke Width", min: 0.5, max: 4, defaultValue: 2 },
      animation: { type: "select", label: "Animation", options: [{ label: "None", value: "none" }, { label: "Spin", value: "spin" }, { label: "Pulse", value: "pulse" }, { label: "Bounce", value: "bounce" }, { label: "Float", value: "float" }], defaultValue: "none" },
      ariaLabel: { type: "text", label: "ARIA Label" },
      decorative: { type: "toggle", label: "Decorative (hidden from screen readers)", defaultValue: true },
    },
    defaultProps: {
      name: "Zap",
      size: "md",
    ...
    ai: {
      description: "An SVG icon display component using Lucide icons with optional background shapes and animations",
      canModify: ["name", "size", "color", "backgroundColor", "backgroundShape", "animation"],
      suggestions: ["Change icon name", "Add background shape", "Enable animation"],
    },
  }),
  ...
  defineComponent({
    ...
    icon: "Music",
    category: "media",
    description: "Audio player with waveform visualisation, cover art, and playback controls",
    render: AudioRender,
    fields: {
      src: { type: "text", label: "Audio URL" },
      title: { type: "text", label: "Track Title", defaultValue: "Audio Track" },
      artist: { type: "text", label: "Artist" },
      cover: { type: "image", label: "Cover Art" },
      autoplay: { type: "toggle", label: "Auto Play", defaultValue: false },
      loop: { type: "toggle", label: "Loop", defaultValue: false },
      preload: { type: "select", label: "Preload", options: [{ label: "Auto", value: "auto" }, { label: "Metadata", value: "metadata" }, { label: "None", value: "none" }], defaultValue: "metadata" },
      variant: { type: "select", label: "Variant", options: [{ label: "Full", value: "full" }, { label: "Compact", value: "compact" }, { label: "Minimal", value: "minimal" }], defaultValue: "full" },
      accentColor: { type: "color", label: "Accent Color" },
      backgroundColor: { type: "color", label: "Background Color" },
      textColor: { type: "color", label: "Text Color" },
      waveformColor: { type: "color", label: "Waveform Color" },
      waveformProgressColor: { type: "color", label: "Waveform Progress Color" },
      showWaveform: { type: "toggle", label: "Show Waveform", defaultValue: true },
      showDuration: { type: "toggle", label: "Show Duration", defaultValue: true },
      showDownload: { type: "toggle", label: "Show Download", defaultValue: false },
      showSpeed: { type: "toggle", label: "Show Speed Control", defaultValue: false },
      borderRadius: { type: "select", label: "Border Radius", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }], defaultValue: "lg" },
      shadow: { type: "select", label: "Shadow", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }], defaultValue: "md" },
      ariaLabel: { type: "text", label: "ARIA Label" },
    },
    defaultProps: {
      title: "Audio Track",
    ...
    ai: {
      description: "An audio player with waveform visualisation, cover art, multiple variants (full/compact/minimal), and playback controls",
      canModify: ["src", "title", "artist", "cover", "variant", "accentColor", "backgroundColor", "showWaveform", "showSpeed"],
      suggestions: ["Switch to compact variant", "Add cover artwork", "Enable speed control"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      ...
      title: { type: "text", label: "Title", defaultValue: "Embedded content" },
      aspectRatio: { type: "select", label: "Aspect Ratio", options: [{ label: "1:1", value: "1:1" }, { label: "4:3", value: "4:3" }, { label: "16:9", value: "16:9" }, { label: "21:9", value: "21:9" }, { label: "Auto", value: "auto" }], defaultValue: "16:9" },
      ...
      border: { type: "toggle", label: "Show Border", defaultValue: false },
      borderColor: { type: "color", label: "Border Color" },
      shadow: { type: "select", label: "Shadow", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }], defaultValue: "sm" },
      backgroundColor: { type: "color", label: "Background Color" },
      loading: { type: "select", label: "Loading", options: [{ label: "Lazy", value: "lazy" }, { label: "Eager", value: "eager" }], defaultValue: "lazy" },
      showLoadingPlaceholder: { type: "toggle", label: "Show Loading Placeholder", defaultValue: true },
      caption: { type: "text", label: "Caption" },
      captionAlign: { type: "select", label: "Caption Align", options: [{ label: "Left", value: "left" }, { label: "Center", value: "center" }, { label: "Right", value: "right" }], defaultValue: "center" },
      captionColor: { type: "color", label: "Caption Color" },
      ariaLabel: { type: "text", label: "ARIA Label" },
    },
    defaultProps: {
    ...
    ai: {
      description: "A secure responsive iframe container for embedding external content like YouTube videos, Google Maps, or other web pages",
      canModify: ["src", "title", "aspectRatio", "maxWidth", "borderRadius", "shadow", "caption"],
      suggestions: ["Embed a YouTube video", "Embed a Google Map", "Add caption"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      ...
      max: { type: "number", label: "Max Visible", min: 1, max: 20, defaultValue: 5 },
      size: { type: "select", label: "Size", options: [{ label: "XS", value: "xs" }, { label: "SM", value: "sm" }, { label: "MD", value: "md" }, { label: "LG", value: "lg" }, { label: "XL", value: "xl" }], defaultValue: "md" },
      overlap: { type: "select", label: "Overlap", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }], defaultValue: "md" },
      direction: { type: "select", label: "Stack Direction", options: [{ label: "Left", value: "left" }, { label: "Right", value: "right" }], defaultValue: "left" },
      overflowStyle: { type: "select", label: "Overflow Style", options: [{ label: "Count", value: "count" }, { label: "Hidden", value: "hidden" }], defaultValue: "count" },
      overflowColor: { type: "color", label: "Overflow Badge Color" },
      overflowTextColor: { type: "color", label: "Overflow Text Color" },
      ringColor: { type: "color", label: "Ring Color" },
    },
    defaultProps: {
      max: 5,
      size: "md",
    ...
    ai: {
      description: "A group of overlapping avatar circles showing team members or users, with a +N overflow count badge",
      canModify: ["avatars", "max", "size", "overlap", "direction", "ringColor"],
      suggestions: ["Add more avatars", "Change size", "Adjust overlap"],
    },
  }),
];
...
const sectionComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    fields: {
      ...
      description: {
        ...
        rows: 3,
        defaultValue:
          "Create beautiful, responsive websites with our powerful drag-and-drop builder.",
      },
      descriptionSize: {
        type: "select",
      ...
      parallaxAffectBackground: {
        type: "toggle",
        label: "Parallax Affects Background",
        defaultValue: true,
      },
      parallaxAffectContent: {
        type: "toggle",
        label: "Parallax Affects Content",
        defaultValue: true,
      },
      // === Decorations ===
      showPattern: {
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Badge",
        icon: "Tag",
        fields: ["badge", "badgeColor", "badgeTextColor", "badgeStyle"],
        defaultExpanded: false,
      },
      {
        id: "buttons",
      ...
      },
      {
        ...
        label: "Decorations",
        icon: "Sparkles",
        fields: ["showPattern", "patternType", "patternOpacity"],
        defaultExpanded: false,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "Zap",
        fields: ["animateOnLoad", "animationType", "animationDelay"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A premium hero section with video backgrounds, split layouts, badges, CTAs, and animations",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    label: "Features",
    description:
      "Premium feature grid with extensive styling, icon options, animations, and CTA sections",
    category: "sections",
    icon: "Grid3X3",
    ...
    fieldGroups: [
      {
        ...
        label: "Header",
        icon: "type",
        fields: ["title", "subtitle", "description", "badge", "badgeIcon"],
        defaultExpanded: true,
      },
      {
        id: "headerStyle",
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "smartphone",
        fields: ["mobileColumns", "stackOnMobile", "compactOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "colors",
    ...
    defaultProps: {
      ...
      features: [
        ...
        },
        {
          icon: "💖",
          title: "User Friendly",
          description: "Intuitive interface loved by thousands of users",
          link: "#",
          isFeatured: false,
        },
        {
        ...
        },
        {
          icon: "🎯",
          title: "Goal Tracking",
          description: "Set, track, and achieve your business goals",
          link: "#",
          isFeatured: false,
        },
      ],
    ...
    ai: {
      description:
        "A premium features grid with comprehensive styling options including icon styles, card effects, animations, numbering, featured highlighting, and CTA sections",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    fields: {
      ...
      mobileButtonFullWidth: {
        type: "toggle",
        label: "Full Width Buttons (Mobile)",
        defaultValue: true,
      },
    },
    fieldGroups: [
      ...
      },
      {
        id: "trust",
        label: "Trust Badges",
        fields: ["trustBadges", "trustBadgesPosition"],
      },
      {
        id: "responsive",
        label: "Responsive",
        fields: ["hideOnMobile", "mobileLayout", "mobileButtonFullWidth"],
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A premium call-to-action section with 80+ customization options including multiple variants (centered, split, glass, floating, banner), gradient backgrounds, trust badges, button animations, and responsive controls",
      canModify: [
        "title",
        "description",
        "subtitle",
  ...
  defineComponent({
    ...
    fieldGroups: [
      ...
      { id: "testimonials", label: "Testimonials", fields: ["testimonials"] },
      {
        id: "layout",
        label: "Layout",
        fields: ["columns", "variant", "contentAlign", "gap"],
      },
      {
        id: "card",
        label: "Card Styling",
      ...
      },
      {
        id: "sizing",
        label: "Sizing",
        fields: ["paddingY", "paddingX", "maxWidth"],
      },
      {
        id: "decorators",
        label: "Decorators",
    ...
    ai: {
      description:
        "Premium testimonials section with 60+ customization options including multiple variants, avatar styles, rating displays, company logos, and animations",
      canModify: [
        "title",
        "subtitle",
        "testimonials",
  ...
  defineComponent({
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "SEO & Schema",
        icon: "Globe",
        fields: ["enableSchema", "schemaType", "ariaLabel"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["mobileColumns", "mobileVariant", "hideDescriptionOnMobile"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      expandedIcon: {
        type: "text",
        label: "Expanded Icon (emoji)",
        group: "icon",
      },
      collapsedIcon: {
        type: "text",
        label: "Collapsed Icon (emoji)",
        group: "icon",
      },
      ...
      mobileColumns: {
        ...
        label: "Mobile Columns",
        group: "responsive",
        options: [{ value: 1, label: "1 Column" }],
      },
      mobileVariant: {
        type: "select",
      ...
      items: [
        {
          ...
          answer:
            "Our platform is designed to be intuitive and easy to use. Simply sign up, configure your settings, and you're ready to go!",
        },
        {
    ...
    ai: {
      description:
        "A comprehensive FAQ section with accordion, search, categories, and multiple styling options",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    label: "Stats",
    description:
      "Statistics and metrics display with animations and multiple variants",
    category: "sections",
    icon: "BarChart3",
    render: StatsRender,
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Value Styling",
        icon: "Hash",
        fields: ["valueSize", "valueColor", "valueFont", "valueFontWeight"],
        defaultExpanded: false,
      },
      {
        id: "label",
      ...
      },
      {
        ...
        label: "Entrance Animation",
        icon: "Play",
        fields: ["animateOnScroll", "animationType", "entranceDelay"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["mobileColumns", "hideDescriptionOnMobile", "compactOnMobile"],
        defaultExpanded: false,
      },
    ],
    fields: {
    ...
    ai: {
      description:
        "A comprehensive statistics section with animated counters, trend indicators, icons, and multiple variants",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    label: "Team",
    description:
      "Premium team section with extensive styling options, social links, and multiple layout variants",
    category: "sections",
    icon: "Users",
    render: TeamRender,
    fields: {
      ...
      hideBioOnMobile: {
        type: "toggle",
        label: "Hide Bio on Mobile",
        defaultValue: true,
      },
      hideSkillsOnMobile: {
        type: "toggle",
        label: "Hide Skills on Mobile",
        defaultValue: true,
      },
      compactOnMobile: { type: "toggle", label: "Compact Layout on Mobile" },
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Bio Settings",
        icon: "file-text",
        fields: ["showBio", "bioMaxLines", "bioSize", "bioColor"],
        defaultExpanded: false,
      },
      {
        id: "social",
      ...
      },
      {
        ...
        label: "Location",
        icon: "map-pin",
        fields: ["showLocation", "locationIcon", "locationColor"],
        defaultExpanded: false,
      },
      {
        id: "filtering",
        label: "Filtering",
        icon: "filter",
        fields: ["showFilter", "filterBy", "filterPosition", "filterStyle"],
        defaultExpanded: false,
      },
      {
        id: "leadership",
        label: "Leadership",
        icon: "award",
        fields: ["highlightLeadership", "leadershipLabel", "featuredScale"],
        defaultExpanded: false,
      },
      {
        id: "sizing",
    ...
    defaultProps: {
      ...
      members: [
        ...
        },
        {
          ...
          role: "Marketing Lead",
          bio: "Driving growth through creative strategies",
          image: "/placeholder-avatar.svg",
          linkedin: "#",
          instagram: "#",
    ...
    ai: {
      description:
        "A premium team section with comprehensive styling options including card styles, image shapes, social links, skills display, filtering, leadership highlighting, animations, and CTA sections",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    label: "Gallery",
    description:
      "Premium image gallery with filtering, lightbox, hover effects, and multiple layout options",
    category: "sections",
    icon: "Images",
    ...
    fields: {
      ...
      ctaTitle: {
        type: "text",
        label: "CTA Title",
        defaultValue: "Want to See More?",
      },
      ctaDescription: {
        type: "textarea",
        label: "CTA Description",
        defaultValue: "Explore our full collection.",
      },
      ctaButtonText: {
        type: "text",
        label: "CTA Button Text",
      ...
      items: {
        type: "array",
        label: "Media Items",
        description: "Mixed media gallery items (images and videos)",
        itemFields: {
          type: { type: "select", label: "Type", options: [{ label: "Image", value: "image" }, { label: "Video", value: "video" }], defaultValue: "image" },
          ...
          category: { type: "text", label: "Category" },
          link: { type: "text", label: "Link URL" },
          linkTarget: { type: "select", label: "Link Target", options: [{ label: "Same Tab", value: "_self" }, { label: "New Tab", value: "_blank" }], defaultValue: "_self" },
        },
      },
      virtualise: {
        type: "toggle",
        label: "Virtual Scrolling",
        description: "Lazy-load gallery items for large collections",
        defaultValue: false,
      },
      infiniteScroll: {
        type: "toggle",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Layout",
        icon: "layout",
        fields: ["variant", "columns", "maxWidth", "gap", "sectionGap"],
        defaultExpanded: false,
      },
      {
        id: "imageStyle",
    ...
    ai: {
      description:
        "A premium image gallery with extensive styling options including multiple layout variants, hover effects, filtering by category, lightbox support, load more pagination, and CTA sections",
      canModify: [
        "title",
        "subtitle",
        "description",
  ...
  defineComponent({
    ...
    fields: {
      items: {
        ...
        itemFields: {
          ...
          iconName: { type: "text", label: "Icon Name" },
          iconColor: { type: "color", label: "Icon Color" },
      ...
      subtitle: { type: "text", label: "Subtitle" },
      description: { type: "textarea", label: "Description" },
      variant: { type: "select", label: "Layout Variant", options: [{ label: "Vertical", value: "vertical" }, { label: "Horizontal", value: "horizontal" }, { label: "Alternating", value: "alternating" }] },
      maxWidth: { type: "select", label: "Max Width", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }, { label: "2XL", value: "2xl" }, { label: "Full", value: "full" }] },
      lineColor: { type: "color", label: "Line Color" },
      lineWidth: { type: "select", label: "Line Width", options: [{ label: "Thin (1px)", value: 1 }, { label: "Normal (2px)", value: 2 }, { label: "Thick (3px)", value: 3 }, { label: "Extra Thick (4px)", value: 4 }] },
      lineStyle: { type: "select", label: "Line Style", options: [{ label: "Solid", value: "solid" }, { label: "Dashed", value: "dashed" }, { label: "Dotted", value: "dotted" }] },
      nodeSize: { type: "select", label: "Node Size", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }] },
      nodeColor: { type: "color", label: "Node Color" },
      nodeStyle: { type: "select", label: "Node Style", options: [{ label: "Dot", value: "dot" }, { label: "Ring", value: "ring" }, { label: "Icon", value: "icon" }] },
      cardBackgroundColor: { type: "color", label: "Card Background" },
      cardBorderColor: { type: "color", label: "Card Border Color" },
      cardBorderRadius: { type: "select", label: "Card Border Radius", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }] },
      ...
      titleColor: { type: "color", label: "Item Title Color" },
      descriptionColor: { type: "color", label: "Item Description Color" },
      dateColor: { type: "color", label: "Date Color" },
      headerTitleColor: { type: "color", label: "Header Title Color" },
      headerSubtitleColor: { type: "color", label: "Header Subtitle Color" },
      headerDescriptionColor: { type: "color", label: "Header Description Color" },
      backgroundColor: { type: "color", label: "Background Color" },
      paddingY: { type: "select", label: "Vertical Padding", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }] },
      paddingX: { type: "select", label: "Horizontal Padding", options: [{ label: "None", value: "none" }, { label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }] },
      gap: { type: "select", label: "Gap Between Items", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }, { label: "XL", value: "xl" }] },
      animateOnScroll: { type: "toggle", label: "Animate on Scroll" },
      ariaLabel: { type: "text", label: "Aria Label" },
    },
    defaultProps: {
      items: [
        {
          title: "Founded",
          description: "Our company was established with a vision to innovate.",
          date: "2020",
          badge: "Milestone",
        },
        {
          title: "First Product Launch",
          description: "We launched our flagship product to market.",
          date: "2021",
        },
        {
          title: "Series A Funding",
          description: "Secured significant funding to accelerate growth.",
          date: "2022",
          badge: "Funding",
        },
        {
    ...
    ai: {
      description:
        "A timeline section for displaying chronological events, milestones, company history, or step-by-step processes. Supports vertical, horizontal, and alternating layouts with customizable nodes, cards, and connecting lines.",
      canModify: [
        "items",
        "title",
        "subtitle",
...
const navigationComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    label: "Navbar",
    description:
      "Premium navigation header with full mobile menu - Wix Studio quality",
    category: "navigation",
    icon: "Menu",
    render: NavbarRender,
    fields: {
    ...
    fieldGroups: [
      {
        ...
        label: "Logo & Branding",
        icon: "Tag",
        fields: ["logo", "logoText", "logoLink", "logoHeight", "logoPosition"],
        defaultExpanded: true,
      },
      {
        id: "navigation",
      ...
      },
      {
        ...
        label: "Layout & Size",
        icon: "LayoutGrid",
        fields: ["layout", "maxWidth", "height", "paddingX"],
        defaultExpanded: false,
      },
      {
        id: "appearance",
      ...
      },
      {
        ...
        label: "Accessibility",
        icon: "Accessibility",
        fields: ["ariaLabel", "skipToContent"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A premium navigation header with full mobile menu, dropdowns, and scroll behaviors",
      canModify: [
        "logoText",
        "links",
        "ctaText",
  ...
  defineComponent({
    ...
    label: "Footer",
    description:
      "Premium site footer with columns, newsletter, and social links - Wix Studio quality",
    category: "navigation",
    icon: "Footprints",
    render: FooterRender,
    fields: {
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        icon: "Smartphone",
        fields: ["showAppStores", "appStoreUrl", "playStoreUrl"],
        defaultExpanded: false,
      },
      {
        id: "legal",
        ...
        icon: "Scale",
        fields: ["copyright", "legalLinks", "showMadeWith", "madeWithText"],
        defaultExpanded: false,
      },
      {
        id: "layout",
    ...
    ai: {
      description:
        "A premium footer with columns, newsletter, social links, and contact info",
      canModify: [
        "companyName",
        "description",
        "copyright",
  ...
  defineComponent({
    ...
    fields: {
      ...
      rel: { type: "text", label: "Rel Attribute" },
      ariaLabel: { type: "text", label: "Aria Label" },
    },
    fieldGroups: [
      {
      ...
      },
      {
        ...
        label: "Style",
        icon: "palette",
        fields: ["variant", "color", "hoverColor", "fontSize", "fontWeight"],
        defaultExpanded: true,
      },
      {
        id: "icon",
        label: "Icon",
        icon: "star",
        fields: ["iconName", "iconPosition", "showExternalIcon"],
        defaultExpanded: false,
      },
      {
        id: "effects",
  ...
  defineComponent({
    ...
    fields: {
      ...
      hoverColor: { type: "color", label: "Hover Color" },
      separatorColor: { type: "color", label: "Separator Color" },
      backgroundColor: { type: "color", label: "Background Color" },
      ariaLabel: {
        type: "text",
        label: "Aria Label",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Colors",
        icon: "droplet",
        fields: ["color", "activeColor", "hoverColor", "separatorColor", "backgroundColor"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
...
const formComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    label: "Form",
    description:
      "Premium form container with built-in submit handling, validation states, and flexible layouts",
    category: "forms",
    icon: "ClipboardList",
    render: FormRender,
    acceptsChildren: true,
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Form Settings",
        icon: "Settings",
        fields: ["action", "method", "enctype", "novalidate", "autocomplete"],
        defaultExpanded: true,
      },
      {
        id: "layout",
        label: "Layout",
        icon: "Layout",
        fields: ["layout", "gap", "labelPosition", "alignItems"],
        defaultExpanded: true,
      },
      {
        id: "sizing",
      ...
      },
      {
        ...
        label: "Appearance",
        icon: "Palette",
        fields: ["backgroundColor", "padding", "borderRadius", "shadow"],
      },
      {
        id: "border",
        label: "Border",
        icon: "Square",
        fields: ["border", "borderColor", "borderWidth"],
      },
      {
        id: "header",
        label: "Header Styling",
      ...
      },
      {
        ...
        label: "Dividers",
        icon: "Minus",
        fields: ["showDividers", "dividerColor"],
      },
      {
        id: "submitButton",
        label: "Submit Button",
      ...
      },
      {
        ...
        label: "Reset Button",
        icon: "RotateCcw",
        fields: ["showResetButton", "resetText"],
      },
      {
        id: "states",
        label: "Loading & States",
        icon: "Loader",
        fields: ["isLoading", "loadingText", "disabled"],
      },
      {
        id: "messages",
        label: "Messages",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Sparkles",
        fields: ["animateOnLoad", "animationType"],
      },
    ],
    fields: {
      // Content
    ...
    ai: {
      description:
        "A premium form container with built-in submit button, validation states, success/error messages, and flexible layouts including vertical, horizontal, and grid options",
      canModify: [
        "title",
        "description",
        "submitText",
  ...
  defineComponent({
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        icon: "Type",
        fields: ["type", "placeholder", "value", "defaultValue"],
        defaultExpanded: true,
      },
      {
        id: "validation",
      ...
      },
      {
        ...
        icon: "AlignLeft",
        fields: ["rows", "cols", "resize"],
      },
      {
        id: "file",
        label: "File Settings",
        icon: "Upload",
        fields: ["accept", "multiple"],
      },
      {
        id: "autocomplete",
        label: "Autocomplete",
        icon: "Zap",
        fields: ["autocomplete", "autofocus", "spellcheck"],
      },
      {
        id: "help",
        label: "Help & Status",
        icon: "HelpCircle",
        fields: ["helpText", "error", "success", "showCharCount"],
      },
      {
        id: "styling",
        label: "Input Styling",
      ...
      },
      {
        ...
        label: "Icon",
        icon: "Star",
        fields: ["iconEmoji", "iconPosition", "iconColor"],
      },
      {
        id: "prefixSuffix",
        label: "Prefix & Suffix",
        icon: "Hash",
        fields: ["prefix", "suffix", "prefixColor", "suffixColor"],
      },
      {
        id: "features",
        label: "Features",
        icon: "Sparkles",
        fields: ["showClearButton", "showPasswordToggle", "showCounter"],
      },
    ],
    fields: {
      // Label & Name
    ...
    ai: {
      description:
        "A premium form input field supporting text, email, password, phone, number, date, textarea, select, checkbox, radio, range, file, and color picker with extensive styling options",
      canModify: [
        "label",
        "placeholder",
        "type",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A pre-built contact form with name, email, and message fields",
...
const contentComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    fields: {
      ...
      titleFontSize: {
        ...
        placeholder: "2.5rem or clamp(2rem, 4vw, 3rem)",
      },
      backgroundColor: { type: "color", label: "Background Color" },
      textColor: { type: "color", label: "Text Color" },
      titleColor: { type: "color", label: "Title Color" },
      subtitleColor: { type: "color", label: "Subtitle Color" },
      accentColor: { type: "color", label: "Accent Color" },
      pullQuoteColor: { type: "color", label: "Pull Quote Color" },
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "FileText",
        fields: ["content", "title", "subtitle", "pullQuote"],
        defaultExpanded: true,
      },
      {
        id: "typography",
        label: "Typography",
        icon: "ALargeSmall",
        fields: ["titleLevel", "proseSize", "titleFontFamily", "bodyFontFamily", "titleFontSize"],
        defaultExpanded: false,
      },
      {
        id: "colors",
        label: "Colors",
        icon: "Palette",
        fields: ["backgroundColor", "textColor", "titleColor", "subtitleColor", "accentColor", "pullQuoteColor", "highlightColor", "cardBackgroundColor"],
        defaultExpanded: false,
      },
      {
        id: "layout",
        label: "Layout",
        icon: "Layout",
        fields: ["layout", "maxWidth", "showDivider", "dividerColor"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description:
        "A rich text content section with title, subtitle, layout options, pull quotes, typography controls, and full color control",
      canModify: ["content", "title", "subtitle", "pullQuote", "layout", "titleLevel", "proseSize", "titleFontFamily", "bodyFontFamily"],
      suggestions: ["Add a title", "Change to two columns", "Add a pull quote"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      ...
      authorTitle: { type: "text", label: "Author Title/Source" },
      ...
      textColor: { type: "color", label: "Text Color" },
      backgroundColor: { type: "color", label: "Background Color" },
      borderColor: { type: "color", label: "Border / Accent Color" },
      fontFamily: {
        type: "select",
        label: "Font Family",
        options: [
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "Quote",
        fields: ["text", "author", "authorTitle", "authorImage"],
        defaultExpanded: true,
      },
      {
        id: "style",
        label: "Style",
        icon: "Palette",
        fields: ["variant", "size", "textColor", "backgroundColor", "borderColor", "fontFamily", "fontStyle"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description: "A blockquote element with 6 variants for displaying quotes, testimonials, and pullquotes",
      canModify: ["text", "author", "authorTitle", "variant", "textColor", "borderColor", "fontFamily"],
      suggestions: ["Make it a testimonial", "Add author details", "Try the modern variant"],
    },
  }),
  ...
  defineComponent({
    ...
    ai: {
      description: "A small utility text element for tags, badges, categories, and overlines",
      canModify: ["text", "variant", "size", "color", "backgroundColor"],
      suggestions: ["Make it a badge", "Try pill style", "Use as overline"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      ...
      color: { type: "color", label: "Text Color" },
      iconColor: { type: "color", label: "Icon / Marker Color" },
      fontSize: {
        type: "select",
        label: "Font Size",
        options: [
    ...
    ai: {
      description: "A styled list component with multiple marker variants including bullets, numbers, checkmarks, and arrows",
      canModify: ["items", "variant", "spacing", "color", "iconColor", "columns"],
  ...
  defineComponent({
    ...
    fields: {
      text: { type: "textarea", label: "Text", rows: 2, defaultValue: "Display" },
      fontSize: {
        type: "text",
        label: "Font Size (CSS)",
        placeholder: "8rem or clamp(4rem, 10vw, 10rem)",
      },
      fontWeight: {
        type: "select",
        label: "Font Weight",
      ...
      textShadow: {
        type: "text",
        label: "Text Shadow (CSS)",
        placeholder: "4px 4px 8px rgba(0,0,0,0.2)",
      },
      textWrap: {
        type: "select",
        label: "Text Wrap",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Typography",
        icon: "ALargeSmall",
        fields: ["fontFamily", "fontSize", "fontWeight", "lineHeight", "letterSpacing", "textTransform"],
        defaultExpanded: false,
      },
      {
        id: "gradient",
        label: "Gradient",
        icon: "Sparkles",
        fields: ["gradient", "gradientFrom", "gradientTo", "gradientDirection"],
        defaultExpanded: false,
      },
      {
        id: "advanced",
        label: "Advanced",
        icon: "Settings",
        fields: ["textShadow", "textWrap", "maxWidth"],
        defaultExpanded: false,
      },
    ],
    defaultProps: {
    ...
    ai: {
      description: "Large decorative display text for hero sections, splash pages, and dramatic headings with gradient support",
      canModify: ["text", "fontSize", "fontWeight", "color", "gradient", "gradientFrom", "gradientTo", "align"],
      suggestions: ["Apply a gradient", "Make it bigger", "Uppercase it"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      text: { type: "text", label: "Text", defaultValue: "Section" },
      variant: {
        type: "select",
        label: "Variant",
        options: [
          { label: "Lines on Sides", value: "line-sides" },
          { label: "Line Through", value: "line-through" },
          { label: "Dots", value: "dots" },
          { label: "Gradient Lines", value: "gradient" },
          { label: "Ornament", value: "ornament" },
        ],
        defaultValue: "line-sides",
      },
      spacing: {
        type: "select",
    ...
    ai: {
      description: "A text element with decorative divider lines, useful for section separators and visual breaks",
      canModify: ["text", "variant", "color", "lineColor", "spacing"],
      suggestions: ["Try gradient lines", "Use dots variant", "Add ornaments"],
    },
  }),
  ...
  defineComponent({
    ...
    fields: {
      value: { type: "text", label: "Value", defaultValue: "100" },
      prefix: { type: "text", label: "Prefix", placeholder: "$" },
      suffix: { type: "text", label: "Suffix", defaultValue: "+" },
      label: { type: "text", label: "Label", defaultValue: "Statistic" },
      color: { type: "color", label: "Value Color" },
      labelColor: { type: "color", label: "Label Color" },
      valueSize: {
        type: "text",
        label: "Value Size (CSS)",
        placeholder: "3rem",
      },
      labelSize: {
        type: "text",
        label: "Label Size (CSS)",
        placeholder: "0.875rem",
      },
      fontFamily: {
        type: "select",
    ...
    ai: {
      description: "A large statistic/metric display component with value, prefix, suffix, and label — uses tabular-nums for aligned numbers",
      canModify: ["value", "prefix", "suffix", "label", "color", "valueSize", "align"],
      suggestions: ["Add a dollar prefix", "Change the suffix", "Make it bigger"],
    },
  }),
];
...
const interactiveComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    label: "Carousel",
    description:
      "Premium carousel with thumbnails, effects, and extensive controls (60+ fields)",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Counter",
        icon: "Hash",
        fields: ["showCounter", "counterPosition", "counterStyle"],
        defaultExpanded: false,
      },
      {
        id: "progress",
      ...
      },
      {
        ...
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "enableKeyboard"],
        defaultExpanded: false,
      },
    ],
    fields: {
    ...
    ai: {
      description:
        "A premium image carousel with thumbnails, multiple transitions, progress bar, and extensive customization",
      canModify: [
        "slides",
        "autoplay",
        "interval",
  ...
  defineComponent({
    ...
    label: "Countdown",
    description:
      "Premium countdown timer with multiple styles and animations (50+ fields)",
    category: "interactive",
    icon: "Clock",
    ...
    fieldGroups: [
      {
        ...
        label: "Target",
        icon: "Calendar",
        fields: ["targetDate", "targetTime", "timezone"],
        defaultExpanded: true,
      },
      {
        id: "content",
        label: "Content",
        icon: "Type",
        fields: ["title", "subtitle", "expiredMessage", "expiredAction"],
        defaultExpanded: false,
      },
      {
        id: "display",
      ...
      },
      {
        ...
        label: "Size",
        icon: "Maximize",
        fields: ["size", "numberSize", "labelSize", "gap"],
        defaultExpanded: false,
      },
      {
        id: "separator",
        label: "Separator",
        icon: "Minus",
        fields: ["separator", "separatorStyle", "showSeparator"],
        defaultExpanded: false,
      },
      {
        id: "card",
      ...
      },
      {
        ...
        label: "On Complete",
        icon: "CircleCheck",
        fields: ["onComplete", "redirectUrl", "showConfetti", "hideOnComplete"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileSize", "stackOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "announceChanges"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      urgencyThreshold: {
        type: "number",
        label: "Urgency Threshold (seconds)",
        min: 0,
        max: 3600,
        defaultValue: 60,
      },
      ...
      urgencyPulse: {
        type: "toggle",
        label: "Pulse on Urgency",
        defaultValue: true,
      },
      urgencySound: {
        type: "toggle",
        label: "Sound on Urgency",
        defaultValue: false,
      },
      // === Completion ===
      ...
      showConfetti: {
        type: "toggle",
        label: "Show Confetti on Complete",
        defaultValue: false,
      },
      hideOnComplete: {
        type: "toggle",
    ...
    ai: {
      description:
        "A premium countdown timer with flip animations, urgency effects, multiple variants, and extensive customization",
      canModify: [
        "targetDate",
        "targetTime",
        "title",
  ...
  defineComponent({
    ...
    label: "Typewriter",
    description:
      "Premium typewriter effect with cursor, multiple sequences, and styling (50+ fields)",
    category: "interactive",
    icon: "Type",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Multiline",
        icon: "AlignLeft",
        fields: ["multiline", "lineHeight", "textAlign"],
        defaultExpanded: false,
      },
      {
        id: "container",
        label: "Container",
        icon: "Square",
        fields: ["minHeight", "backgroundColor", "padding", "borderRadius"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileFontSize"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    ai: {
      description:
        "A premium typewriter effect with customizable cursor, timing, typo simulation, and multiple text sequences",
      canModify: [
        "texts",
        "typingSpeed",
        "prefix",
  ...
  defineComponent({
    ...
    label: "Parallax",
    description:
      "Premium parallax scrolling with multiple layers and effects (50+ fields)",
    category: "interactive",
    icon: "Layers",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        icon: "Layers",
        fields: ["speed", "direction", "maxOffset", "easing", "disabled"],
        defaultExpanded: false,
      },
      {
        id: "overlay",
      ...
      },
      {
        ...
        label: "Size",
        icon: "Maximize",
        fields: ["height", "minHeight", "maxHeight", "fullScreen"],
        defaultExpanded: false,
      },
      {
        id: "content",
      ...
      },
      {
        ...
        label: "Effects",
        icon: "Sparkles",
        fields: ["blur", "scale", "rotate", "opacity", "fadeOnScroll"],
        defaultExpanded: false,
      },
      {
        id: "border",
        label: "Border & Shadow",
        icon: "Square",
        fields: ["borderRadius", "shadow", "showBorder", "borderColor"],
        defaultExpanded: false,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "Zap",
        fields: ["animateOnMount", "animationType", "animationDuration"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["disableOnMobile", "mobileHeight", "mobileFallbackImage"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "reducedMotion"],
        defaultExpanded: false,
      },
    ],
    fields: {
    ...
    ai: {
      description:
        "A premium parallax section with multiple layers, overlay effects, and extensive customization for immersive scrolling experiences",
      canModify: [
        "backgroundImage",
        "speed",
        "height",
  ...
  defineComponent({
    ...
    label: "Pricing",
    description:
      "Premium pricing table with toggle, animations, and extensive styling (70+ fields)",
    category: "interactive",
    icon: "CreditCard",
    ...
    fieldGroups: [
      {
        ...
        label: "Header",
        icon: "Type",
        fields: ["title", "subtitle", "description", "badge", "headerAlign"],
        defaultExpanded: false,
      },
      {
        id: "plans",
      ...
      },
      {
        ...
        label: "Layout",
        icon: "Layout",
        fields: ["variant", "columns", "gap", "alignment", "maxWidth"],
        defaultExpanded: false,
      },
      {
        id: "cardStyle",
      ...
      },
      {
        ...
        label: "Guarantee",
        icon: "Shield",
        fields: ["showGuarantee", "guaranteeText", "guaranteeIcon"],
        defaultExpanded: false,
      },
      {
        id: "comparison",
        label: "Comparison",
        icon: "Table",
        fields: ["showComparison", "comparisonButtonText"],
        defaultExpanded: false,
      },
      {
        id: "animation",
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "Smartphone",
        fields: ["mobileColumns", "stackOnMobile", "hideToggleOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      toggleLabels: {
        type: "text",
        label: "Toggle Labels (comma-separated)",
      ...
      strikethroughOriginal: {
        type: "toggle",
        label: "Strikethrough Original Price",
        defaultValue: true,
      },
      // === Features ===
      featureStyle: {
    ...
    ai: {
      description:
        "A premium pricing table with billing toggle, feature comparison, guarantees, and extensive styling for SaaS pricing pages",
      canModify: [
        "title",
        "plans",
        "variant",
  ...
  defineComponent({
    ...
    label: "Accordion",
    description:
      "Premium accordion with icons, animations, and extensive styling (50+ fields)",
    category: "interactive",
    icon: "ChevronsUpDown",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Behavior",
        icon: "Settings",
        fields: ["allowMultiple", "defaultOpenItems", "collapseAll"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Zap",
        fields: ["animationType", "animationDuration", "animateContent"],
        defaultExpanded: false,
      },
      {
        id: "search",
        label: "Search",
        icon: "Search",
        fields: ["showSearch", "searchPlaceholder", "highlightMatch"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileVariant"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      defaultOpenItems: {
        type: "text",
        label: "Default Open Items (comma-separated indices)",
      },
      collapseAll: {
        type: "toggle",
        label: "Collapse All Initially",
        defaultValue: false,
      },
      // === Style ===
      variant: {
    ...
    ai: {
      description:
        "A premium accordion with search, icons, badges, animations, and multiple styling variants for FAQs and collapsible content",
      canModify: [
        "items",
        "variant",
        "allowMultiple",
  ...
  defineComponent({
    ...
    label: "Tabs",
    description:
      "Premium tabs with icons, badges, and extensive styling (50+ fields)",
    category: "interactive",
    icon: "LayoutList",
    render: TabsRender,
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Behavior",
        icon: "Settings",
        fields: ["defaultTab", "keepAlive", "lazyLoad"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Size & Layout",
        icon: "Maximize",
        fields: ["size", "fullWidth", "centered", "gap", "tabsPosition"],
        defaultExpanded: false,
      },
      {
        id: "border",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Zap",
        fields: ["animationType", "animationDuration", "slideDirection"],
        defaultExpanded: false,
      },
      {
        id: "icons",
        label: "Icons",
        icon: "Image",
        fields: ["showIcons", "iconPosition", "iconSize"],
        defaultExpanded: false,
      },
      {
        id: "badges",
      ...
      },
      {
        ...
        label: "Overflow",
        icon: "MoreHorizontal",
        fields: ["overflowBehavior", "showScrollButtons", "scrollButtonStyle"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["mobileVariant", "collapseOnMobile", "mobileDropdown"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    ai: {
      description:
        "A premium tab component with icons, badges, animations, vertical layouts, and extensive styling for organized content",
      canModify: [
        "tabs",
        "variant",
        "size",
  ...
  defineComponent({
    ...
    label: "Modal",
    description:
      "Premium modal/dialog with animations, forms, and extensive styling (50+ fields)",
    category: "interactive",
    icon: "Square",
    render: ModalRender,
    acceptsChildren: true,
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "Type",
        fields: ["title", "description", "showHeader", "showFooter"],
        defaultExpanded: true,
      },
      {
        id: "state",
      ...
      },
      {
        ...
        label: "Overlay",
        icon: "Layers",
        fields: ["overlayColor", "overlayOpacity", "overlayBlur"],
        defaultExpanded: false,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "Zap",
        fields: ["animationType", "animationDuration", "animationDirection"],
        defaultExpanded: false,
      },
      {
        id: "draggable",
        label: "Draggable",
        icon: "Move",
        fields: ["draggable", "dragHandle", "dragBounds"],
        defaultExpanded: false,
      },
      {
        id: "focus",
        ...
        icon: "Eye",
        fields: ["trapFocus", "autoFocus", "returnFocus"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["mobileFullScreen", "mobilePosition", "mobileAnimation"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "ariaDescribedBy", "role"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      autoFocus: {
        type: "toggle",
        label: "Auto Focus First Element",
        defaultValue: true,
      },
      returnFocus: {
        type: "toggle",
        label: "Return Focus on Close",
        defaultValue: true,
      },
      // === Responsive ===
      mobileFullScreen: {
    ...
    ai: {
      description:
        "A premium modal/dialog with animations, footer buttons, draggable support, and extensive styling for popups and dialogs",
      canModify: [
        "title",
        "description",
        "size",
...
const uiComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    label: "Avatar",
    description:
      "Premium avatar with status, badges, groups, and extensive styling (50+ fields)",
    category: "content",
    icon: "UserCircle",
    render: AvatarRender,
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Size & Shape",
        icon: "Maximize",
        fields: ["size", "customSize", "shape", "aspectRatio"],
        defaultExpanded: false,
      },
      {
        id: "status",
      ...
      },
      {
        ...
        label: "Tooltip",
        icon: "MessageCircle",
        fields: ["showTooltip", "tooltipText", "tooltipPosition"],
        defaultExpanded: false,
      },
      {
        id: "group",
        label: "Group Stacking",
        icon: "Users",
        fields: ["isGrouped", "groupOverlap", "groupZIndex", "showMoreCount"],
        defaultExpanded: false,
      },
      {
        id: "link",
        label: "Link/Click",
        icon: "Link",
        fields: ["asLink", "href", "linkTarget", "clickable", "onClick"],
        defaultExpanded: false,
      },
      {
        id: "animation",
    ...
    ai: {
      description:
        "A premium avatar component with status indicators, badges, tooltips, grouping support, and extensive styling options",
      canModify: [
        "src",
        "name",
        "size",
  ...
  defineComponent({
    ...
    label: "Progress",
    description:
      "Premium progress bar with animations, labels, and multiple variants (50+ fields)",
    category: "content",
    icon: "BarChart",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Labels",
        icon: "Type",
        fields: ["label", "labelPosition", "description", "showMinMax"],
        defaultExpanded: false,
      },
      {
        id: "size",
        label: "Size & Shape",
        icon: "Maximize",
        fields: ["size", "customHeight", "rounded", "customBorderRadius"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Segments",
        icon: "LayoutList",
        fields: ["segmented", "segmentCount", "segmentGap"],
        defaultExpanded: false,
      },
      {
        id: "stripe",
      ...
      },
      {
        ...
        label: "Glow & Shadow",
        icon: "Sun",
        fields: ["glowEffect", "glowColor", "shadow", "innerShadow"],
        defaultExpanded: false,
      },
      {
        id: "milestones",
      ...
      },
      {
        ...
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "ariaValueText"],
        defaultExpanded: false,
      },
    ],
    fields: {
    ...
    ai: {
      description:
        "A premium progress bar with gradients, stripes, segments, milestones, circular mode, and extensive animation options",
      canModify: [
        "value",
        "label",
        "color",
  ...
  defineComponent({
    ...
    label: "Alert",
    description:
      "Premium alert with actions, progress, and extensive styling (50+ fields)",
    category: "content",
    icon: "AlertCircle",
    render: AlertRender,
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Icon",
        icon: "AlertCircle",
        fields: ["showIcon", "customIcon", "iconPosition", "iconSize"],
        defaultExpanded: false,
      },
      {
        id: "size",
        label: "Size & Layout",
        icon: "Maximize",
        fields: ["size", "layout", "fullWidth", "maxWidth"],
        defaultExpanded: false,
      },
      {
        id: "border",
      ...
      },
      {
        ...
        label: "Link",
        icon: "Link",
        fields: ["showLink", "linkText", "linkUrl", "linkTarget"],
        defaultExpanded: false,
      },
      {
        id: "animation",
    ...
    ai: {
      description:
        "A premium alert component with actions, auto-close, progress bar, and extensive styling options",
      canModify: [
        "title",
        "message",
        "variant",
  ...
  defineComponent({
    ...
    label: "Tooltip",
    description:
      "Premium tooltip with rich content, arrows, and animations (50+ fields)",
    category: "content",
    icon: "MessageSquare",
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "Type",
        fields: ["text", "title", "description", "richContent"],
        defaultExpanded: true,
      },
      {
        id: "position",
        label: "Position",
        icon: "Move",
        fields: ["position", "alignment", "offset", "followCursor"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Arrow",
        icon: "Triangle",
        fields: ["showArrow", "arrowSize", "arrowColor"],
        defaultExpanded: false,
      },
      {
        id: "border",
        label: "Border & Shadow",
        icon: "Square",
        fields: ["showBorder", "borderWidth", "borderRadius", "shadow"],
        defaultExpanded: false,
      },
      {
        id: "trigger",
        label: "Trigger",
        icon: "MousePointer",
        fields: ["trigger", "openDelay", "closeDelay", "hideOnClick"],
        defaultExpanded: false,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "Zap",
        fields: ["animationType", "animationDuration"],
        defaultExpanded: false,
      },
      {
        id: "interactive",
        label: "Interactive",
        icon: "Hand",
        fields: ["interactive", "interactiveDebounce", "showCloseButton"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobilePosition"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      interactive: {
        type: "toggle",
        label: "Interactive (Hoverable)",
        defaultValue: false,
      },
      interactiveDebounce: {
        type: "number",
        label: "Interactive Debounce (ms)",
        min: 0,
        max: 500,
        defaultValue: 100,
      },
    ...
    ai: {
      description:
        "A premium tooltip with rich content, customizable arrows, animations, and interactive mode",
      canModify: [
        "text",
        "title",
        "position",
...
const marketingComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    description:
      "Premium top banner with countdown, animations, and extensive styling options (50+ fields)",
    category: "marketing",
    icon: "Bell",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Spacing",
        icon: "Maximize",
        fields: ["paddingY", "paddingX", "height"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "hideOnTablet", "mobileSize", "stackOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      showOnce: {
        type: "toggle",
        label: "Show Once (Use Cookie)",
        defaultValue: false,
      },
      cookieName: {
        type: "text",
        label: "Cookie Name",
        defaultValue: "announcement_closed",
      },
  ...
  defineComponent({
    ...
    label: "Social Proof",
    description:
      "Premium social proof with avatars, ratings, live counters, and animations (50+ fields)",
    category: "marketing",
    icon: "Users",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Layout",
        icon: "Layout",
        fields: ["variant", "alignment", "direction", "gap", "maxWidth"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Typography",
        icon: "Type",
        fields: ["countSize", "countWeight", "labelSize", "textSize"],
        defaultExpanded: false,
      },
      {
        id: "card",
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileVariant", "compactOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      ratingText: {
        type: "text",
        label: "Rating Text",
        defaultValue: "{rating} out of {max}",
      },
      // === Live Counter ===
      animateCount: {
        type: "toggle",
      ...
      ariaLabel: {
        type: "text",
        label: "Aria Label",
        defaultValue: "Social proof statistics",
      },
    },
    defaultProps: {
  ...
  defineComponent({
    ...
    label: "Trust Badges",
    description:
      "Premium trust and security badges with animations and extensive styling (50+ fields)",
    category: "marketing",
    icon: "ShieldCheck",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Spacing",
        icon: "Maximize",
        fields: ["paddingY", "paddingX", "sectionGap"],
        defaultExpanded: false,
      },
      {
        id: "animation",
    ...
    fields: {
      ...
      ariaLabel: {
        type: "text",
        label: "Aria Label",
        defaultValue: "Trust and security badges",
      },
    },
    defaultProps: {
      badges: [
    ...
    ai: {
      description:
        "Premium trust badges with multiple variants, hover effects, tooltips, staggered animations, and extensive styling",
      canModify: [
        "badges",
        "variant",
        "alignment",
  ...
  defineComponent({
    ...
    label: "Logo Cloud",
    description:
      "Premium logo display with infinite scroll, animations, and 60+ customization options",
    category: "marketing",
    icon: "Building2",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileLogoSize", "compactOnMobile"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    ai: {
      description:
        "A premium logo cloud for displaying client, partner, or certification logos with infinite scroll, grayscale effects, animations, and extensive styling options",
      canModify: [
        "title",
        "logos",
        "variant",
  ...
  defineComponent({
    ...
    description:
      "Premium feature comparison with highlighting, icons, and 70+ customization options",
    category: "marketing",
    icon: "Table",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Layout",
        icon: "Layout",
        fields: ["variant", "maxWidth", "stickyHeader", "stickyFirstColumn"],
        defaultExpanded: false,
      },
      {
        id: "headerRow",
      ...
      },
      {
        ...
        label: "Shadow",
        icon: "Layers",
        fields: ["tableShadow", "hoverShadow"],
        defaultExpanded: false,
      },
      {
        id: "background",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Zap",
        fields: ["animateOnScroll", "animationType", "animationDelay"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
      ...
      },
      {
        ...
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "enableKeyboardNav"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      rows: {
        ...
        itemFields: {
          ...
          values: {
            type: "text",
            label: "Values (comma-separated: yes,no,partial,text)",
          },
      ...
      highlightedColumnBorder: {
        type: "color",
        label: "Highlighted Border",
        defaultValue: "",
      },
      highlightedBadgeText: {
        type: "text",
        label: "Highlighted Badge",
        defaultValue: "Most Popular",
      },
      highlightedBadgeColor: {
        type: "color",
        label: "Highlighted Badge Color",
        defaultValue: "",
      },
      // === Row Style ===
      rowBackgroundColor: {
      ...
      ariaLabel: {
        type: "text",
        label: "Aria Label",
        defaultValue: "Feature comparison table",
      },
      enableKeyboardNav: {
        type: "toggle",
        label: "Enable Keyboard Navigation",
    ...
    ai: {
      description:
        "A premium feature comparison table with column highlighting, CTA buttons, tooltips, icons, sticky headers, and extensive styling options",
      canModify: [
        "title",
        "columns",
        "rows",
...
const effectsComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    label: "3D Flip Card",
    description:
      "Premium 3D flip card with multiple effects and extensive styling (60+ fields)",
    category: "3d",
    icon: "RotateCcw",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Zap",
        fields: ["animateOnMount", "mountAnimation", "hoverPause"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileFlipOn", "mobileWidth"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "ariaDescription", "reducedMotion"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      backDescription: {
        ...
        defaultValue: "Amazing content here",
      },
    ...
    ai: {
      description:
        "A premium 3D flip card with gradients, glow effects, and extensive customization for team members, products, or features",
      canModify: [
        "frontTitle",
        "frontDescription",
        "backTitle",
  ...
  defineComponent({
    ...
    label: "3D Tilt Card",
    description:
      "Premium tilt card with glare, reflections, and extensive styling (55+ fields)",
    category: "3d",
    icon: "Move3d",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Border",
        icon: "Square",
        fields: ["showBorder", "borderColor", "borderWidth", "borderGlow"],
        defaultExpanded: false,
      },
      {
        id: "effects",
      ...
      },
      {
        ...
        label: "Animation",
        icon: "Zap",
        fields: ["animateOnMount", "mountAnimation", "animationDuration"],
        defaultExpanded: false,
      },
      {
        id: "responsive",
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "disableOnMobile", "mobileScale"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      description: {
        type: "textarea",
        label: "Description",
        defaultValue: "Hover to see 3D tilt effect",
      },
      icon: { type: "text", label: "Icon (emoji)" },
      badge: { type: "text", label: "Badge Text" },
      badgeColor: { type: "color", label: "Badge Color", defaultValue: "" },
    ...
    ai: {
      description:
        "A premium interactive card with 3D tilt, glare effects, and extensive customization for modern UI",
      canModify: [
        "title",
        "description",
        "backgroundColor",
  ...
  defineComponent({
    ...
    label: "Glass Card",
    description:
      "Premium glassmorphism card with advanced blur and effects (55+ fields)",
    category: "3d",
    icon: "Sparkles",
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "Type",
        fields: ["title", "subtitle", "description", "icon", "badge"],
        defaultExpanded: true,
      },
      {
        id: "glass",
      ...
      },
      {
        ...
        label: "Shadow",
        icon: "Layers",
        fields: ["shadow", "shadowColor", "shadowBlur", "innerShadow"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Button",
        icon: "MousePointer",
        fields: ["showButton", "buttonText", "buttonLink", "buttonVariant"],
        defaultExpanded: false,
      },
      {
        id: "icon",
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileBlur", "mobilePadding"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      description: {
        type: "textarea",
        label: "Description",
        defaultValue: "Beautiful frosted glass effect",
      },
      icon: { type: "text", label: "Icon (emoji)" },
      badge: { type: "text", label: "Badge Text" },
      // === Glass Effect ===
    ...
    ai: {
      description:
        "A premium glassmorphism card with advanced blur, gradients, and hover effects for modern UI",
      canModify: [
        "title",
        "description",
        "preset",
  ...
  defineComponent({
    ...
    description:
      "Premium animated particle effects with extensive customization (60+ fields)",
    category: "3d",
    icon: "Atom",
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Size",
        icon: "Maximize",
        fields: ["height", "fullScreen", "minHeight", "maxHeight"],
        defaultExpanded: false,
      },
      {
        id: "effects",
      ...
      },
      {
        ...
        label: "Spawn",
        icon: "Zap",
        fields: ["spawnRate", "spawnPosition", "lifetime", "fadeIn", "fadeOut"],
        defaultExpanded: false,
      },
      {
        id: "performance",
      ...
      },
      {
        ...
        label: "Accessibility",
        icon: "Eye",
        fields: ["ariaLabel", "reducedMotion", "pauseOnReducedMotion"],
        defaultExpanded: false,
      },
    ],
    fields: {
      ...
      pauseOnBlur: {
        type: "toggle",
        label: "Pause When Tab Not Visible",
        defaultValue: true,
      },
      reducedOnMobile: {
        type: "toggle",
        label: "Reduced on Mobile",
        defaultValue: true,
      },
      mobileParticleCount: {
        type: "number",
        label: "Mobile Particle Count",
        min: 10,
        max: 100,
        defaultValue: 25,
      },
      ...
      ariaLabel: {
        type: "text",
        label: "Aria Label",
        defaultValue: "Animated particle background",
      },
      reducedMotion: {
        type: "toggle",
        label: "Respect Reduced Motion",
    ...
    ai: {
      description:
        "A premium animated particle background with interactivity, connections, and extensive customization for hero sections",
      canModify: [
        "particleCount",
        "particleColor",
        "speed",
  ...
  defineComponent({
    ...
    label: "Scroll Animation",
    description:
      "Premium scroll-triggered animations with extensive customization (55+ fields)",
    category: "3d",
    icon: "MoveVertical",
    ...
    fieldGroups: [
      {
        ...
        label: "Content",
        icon: "Type",
        fields: ["title", "subtitle", "description", "richContent"],
        defaultExpanded: true,
      },
      {
        id: "animation",
        label: "Animation",
        icon: "Zap",
        fields: ["animation", "customAnimation", "duration", "delay", "easing"],
        defaultExpanded: false,
      },
      {
        id: "trigger",
      ...
      },
      {
        ...
        label: "Sequence",
        icon: "List",
        fields: ["stagger", "staggerDelay", "staggerDirection", "staggerFrom"],
        defaultExpanded: false,
      },
      {
        id: "distance",
        label: "Distance",
        icon: "Move",
        fields: ["translateX", "translateY", "scale", "rotate", "skew"],
        defaultExpanded: false,
      },
      {
        id: "style",
      ...
      },
      {
        ...
        label: "Parallax",
        icon: "Layers",
        fields: ["parallax", "parallaxSpeed", "parallaxDirection"],
        defaultExpanded: false,
      },
      {
        id: "effects",
        label: "Effects",
        icon: "Wand2",
        fields: ["blur", "opacity", "scaleStart", "rotateStart"],
        defaultExpanded: false,
      },
      {
        id: "counter",
      ...
      },
      {
        ...
        label: "Responsive",
        icon: "Smartphone",
        fields: ["hideOnMobile", "mobileAnimation", "reducedMotionAnimation"],
        defaultExpanded: false,
      },
      {
        id: "accessibility",
    ...
    fields: {
      ...
      description: {
        type: "textarea",
        label: "Description",
        defaultValue: "This content animates when you scroll",
      },
      ...
      progressBased: {
        type: "toggle",
        label: "Progress-based Animation",
        defaultValue: false,
      },
      progressStart: {
        type: "number",
      ...
      reducedMotionAnimation: {
        type: "select",
        label: "Reduced Motion Animation",
        options: [
          { label: "Fade", value: "fade" },
          { label: "None", value: "none" },
        ],
    ...
    ai: {
      description:
        "A premium scroll-triggered animation wrapper with parallax, stagger, and progress-based effects",
      canModify: [
        "title",
        "description",
        "animation",
      ...
      suggestions: [
        ...
        "Add parallax effect",
        "Use progress-based animation",
        "Add animated counter",
        "Try bounce-in animation",
      ],
    },
  }),

  // ---------------------------------------------------------------------------
  // BlogPreview — Blog Post Cards
  // ---------------------------------------------------------------------------
  defineComponent({
    type: "BlogPreview",
    label: "Blog Preview",
    ...
    icon: "Newspaper",
    render: BlogPreviewRender,
    fields: {
      // Header
      title: { type: "text", label: "Section Title", defaultValue: "Latest Posts" },
      subtitle: { type: "text", label: "Subtitle" },
      badge: { type: "text", label: "Badge" },
      badgeColor: { type: "color", label: "Badge Color" },
      headerAlign: { type: "select", label: "Header Alignment", defaultValue: "center", options: [
        { label: "Left", value: "left" },
        { label: "Center", value: "center" },
        { label: "Right", value: "right" },
      ]},
      // Layout
      variant: { type: "select", label: "Layout", defaultValue: "grid", options: [
        { label: "Grid", value: "grid" },
        { label: "List", value: "list" },
        { label: "Featured", value: "featured" },
        { label: "Cards", value: "cards" },
      ]},
      columns: { type: "select", label: "Columns", defaultValue: "3", options: [
        { label: "2 Columns", value: "2" },
        { label: "3 Columns", value: "3" },
        { label: "4 Columns", value: "4" },
      ]},
      // Posts
      posts: { type: "array", label: "Posts", itemFields: {
        title: { type: "text", label: "Title" },
        excerpt: { type: "textarea", label: "Excerpt" },
        image: { type: "image", label: "Image" },
        author: { type: "text", label: "Author" },
        authorAvatar: { type: "image", label: "Author Avatar" },
        date: { type: "text", label: "Date" },
        category: { type: "text", label: "Category" },
      ...
      // Display Options
      showAuthor: { type: "toggle", label: "Show Author", defaultValue: true },
      showDate: { type: "toggle", label: "Show Date", defaultValue: true },
      showCategory: { type: "toggle", label: "Show Category", defaultValue: true },
      showReadTime: { type: "toggle", label: "Show Read Time", defaultValue: false },
      showExcerpt: { type: "toggle", label: "Show Excerpt", defaultValue: true },
      // Image
      imageAspectRatio: { type: "select", label: "Image Aspect Ratio", defaultValue: "video", options: [
        { label: "16:9", value: "video" },
        { label: "1:1", value: "square" },
        { label: "21:9", value: "wide" },
      ]},
      imageRounded: { type: "select", label: "Image Rounding", defaultValue: "lg", options: [
        { label: "None", value: "none" },
        { label: "Small", value: "sm" },
        { label: "Medium", value: "md" },
        { label: "Large", value: "lg" },
      ...
      // Card Style
      cardBorderRadius: { type: "select", label: "Card Border Radius", defaultValue: "xl", options: [
        { label: "None", value: "none" },
        { label: "Small", value: "sm" },
        { label: "Medium", value: "md" },
        { label: "Large", value: "lg" },
      ...
      cardShadow: { type: "select", label: "Card Shadow", defaultValue: "md", options: [
        { label: "None", value: "none" },
        { label: "Small", value: "sm" },
        { label: "Medium", value: "md" },
        { label: "Large", value: "lg" },
      ...
      // Colors
      backgroundColor: { type: "color", label: "Background Color" },
      categoryColor: { type: "color", label: "Category Color" },
      titleColor: { type: "color", label: "Title Color" },
      excerptColor: { type: "color", label: "Excerpt Color" },
      metaColor: { type: "color", label: "Meta Color" },
      // CTA
      ctaText: { type: "text", label: "CTA Text" },
      ctaLink: { type: "text", label: "CTA Link" },
      ctaColor: { type: "color", label: "CTA Color" },
      // Spacing
      paddingY: { type: "select", label: "Vertical Padding", defaultValue: "lg", options: [
        { label: "Small", value: "sm" },
        { label: "Medium", value: "md" },
        { label: "Large", value: "lg" },
        { label: "XL", value: "xl" },
      ]},
      paddingX: { type: "select", label: "Horizontal Padding", defaultValue: "md", options: [
        { label: "Small", value: "sm" },
        { label: "Medium", value: "md" },
        { label: "Large", value: "lg" },
        { label: "XL", value: "xl" },
    ...
    fieldGroups: [
      { id: "header", label: "Header", icon: "Type", fields: ["title", "subtitle", "badge", "badgeColor", "headerAlign"] },
      { id: "layout", label: "Layout", icon: "LayoutGrid", fields: ["variant", "columns"] },
      { id: "posts", label: "Posts", icon: "FileText", fields: ["posts"], defaultExpanded: true },
      { id: "display", label: "Display", icon: "Eye", fields: ["showAuthor", "showDate", "showCategory", "showReadTime", "showExcerpt"] },
      { id: "image", label: "Image", icon: "Image", fields: ["imageAspectRatio", "imageRounded"] },
      { id: "cardStyle", label: "Card Style", icon: "Square", fields: ["cardBorderRadius", "cardShadow", "cardBorderColor", "cardBackgroundColor"] },
      { id: "colors", label: "Colors", icon: "Palette", fields: ["backgroundColor", "categoryColor", "titleColor", "excerptColor", "metaColor"] },
      { id: "cta", label: "CTA", icon: "ExternalLink", fields: ["ctaText", "ctaLink", "ctaColor"] },
      { id: "spacing", label: "Spacing", icon: "Move", fields: ["paddingY", "paddingX"] },
    ],
    defaultProps: {
      title: "Latest Posts",
      variant: "grid",
      ...
      paddingX: "md",
      posts: [
        { title: "Getting Started", excerpt: "Learn the basics of our platform.", image: "", author: "Admin", date: "2025-01-15", category: "Tutorial" },
        { title: "Best Practices", excerpt: "Tips for getting the most out of your site.", image: "", author: "Admin", date: "2025-01-10", category: "Guide" },
        { title: "What's New", excerpt: "Check out our latest features and updates.", image: "", author: "Admin", date: "2025-01-05", category: "News" },
      ],
    },
    ai: {
      description: "Blog post preview section supporting grid, list, featured, or card layouts. Each post has image, category, title, excerpt, author with avatar, date, and read time. Section includes header with badge, CTA link, and responsive dark-mode-aware styling.",
      canModify: [
        "title", "subtitle", "badge", "variant", "columns", "posts",
        "showAuthor", "showDate", "showCategory", "showReadTime", "showExcerpt",
        "imageAspectRatio", "imageRounded", "cardBorderRadius", "cardShadow",
        "backgroundColor", "categoryColor", "titleColor", "excerptColor", "metaColor",
        "ctaText", "ctaLink", "ctaColor", "paddingY", "paddingX",
      ],
      suggestions: [
        "Use variant=featured for hero-style blog layout",
        "Add category badges for filtering context",
        "Show author avatars for social proof",
...
export function registerCoreComponents(): void {
  ...
  console.log(
    `[Studio] Registered ${componentRegistry.coreCount} core components`,
  );
}
