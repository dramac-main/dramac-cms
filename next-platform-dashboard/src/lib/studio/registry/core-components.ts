...
const sectionComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    fieldGroups: [
      { id: "content", label: "✏️ Content", fields: ["title", "titleSize", "titleColor", "titleWeight", "titleAlign", "subtitle", "subtitleSize", "subtitleColor", "description", "descriptionSize", "descriptionColor", "descriptionMaxWidth"], defaultExpanded: true },
      { id: "badge", label: "🏷️ Badge", fields: ["badge", "badgeColor", "badgeTextColor", "badgeStyle"], defaultExpanded: false },
      { id: "buttons", label: "🎯 Buttons", fields: ["primaryButtonText", "primaryButtonLink", "primaryButtonColor", "primaryButtonTextColor", "primaryButtonStyle", "primaryButtonSize", "primaryButtonRadius", "primaryButtonIcon", "secondaryButtonText", "secondaryButtonLink", "secondaryButtonStyle", "secondaryButtonColor"], defaultExpanded: true },
      { id: "layout", label: "📐 Layout", fields: ["variant", "contentAlign", "verticalAlign", "minHeight", "maxWidth", "paddingTop", "paddingBottom", "paddingX"], defaultExpanded: false },
      { id: "background", label: "🖼️ Background", fields: ["backgroundColor", "backgroundImage", "backgroundPosition", "backgroundSize", "backgroundAttachment", "backgroundOverlay", "backgroundOverlayColor", "backgroundOverlayOpacity", "backgroundGradient"], defaultExpanded: false },
      { id: "video", label: "🎬 Video Background", fields: ["videoSrc", "videoPoster", "videoAutoplay", "videoLoop", "videoMuted", "showVideoControls", "showPlayButton", "playButtonSize", "playButtonColor"], defaultExpanded: false },
      { id: "image", label: "🖼️ Hero Image", fields: ["image", "imageAlt", "imagePosition", "imageFit", "imageRounded", "imageShadow", "imageAnimation"], defaultExpanded: false },
      { id: "scroll", label: "⬇️ Scroll Indicator", fields: ["showScrollIndicator", "scrollIndicatorIcon", "scrollIndicatorColor", "scrollIndicatorSize", "scrollIndicatorAnimation", "scrollIndicatorLabel", "scrollTarget"], defaultExpanded: false },
      { id: "parallax", label: "✨ Mouse Parallax", fields: ["enableMouseParallax", "mouseParallaxIntensity", "mouseParallaxLayers", "mouseParallaxSmooth"], defaultExpanded: false },
      { id: "decorations", label: "🎨 Decorations", fields: ["showPattern", "patternType", "patternOpacity"], defaultExpanded: false },
      { id: "animation", label: "🎭 Animation", fields: ["animateOnLoad", "animationType", "animationDelay"], defaultExpanded: false },
    ],
    defaultProps: {
...
const navigationComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    fieldGroups: [
      { id: "branding", label: "🏷️ Logo & Branding", fields: ["logo", "logoText", "logoLink", "logoHeight", "logoPosition"], defaultExpanded: true },
      { id: "navigation", label: "🔗 Navigation Links", fields: ["links", "linkAlignment", "linkSpacing", "linkFontSize", "linkFontWeight", "linkTextTransform", "linkHoverEffect", "linkActiveIndicator"], defaultExpanded: true },
      { id: "cta", label: "🎯 Call to Action", fields: ["ctaText", "ctaLink", "ctaStyle", "ctaColor", "ctaTextColor", "ctaSize", "ctaBorderRadius", "ctaIcon", "secondaryCtaText", "secondaryCtaLink", "secondaryCtaStyle"], defaultExpanded: false },
      { id: "layout", label: "📐 Layout & Size", fields: ["layout", "maxWidth", "height", "paddingX"], defaultExpanded: false },
      { id: "appearance", label: "🎨 Colors & Style", fields: ["backgroundColor", "backgroundOpacity", "textColor", "borderBottom", "borderColor", "borderWidth", "shadow", "glassEffect", "glassBlur"], defaultExpanded: false },
      { id: "behavior", label: "⚙️ Position & Behavior", fields: ["position", "stickyOffset", "hideOnScroll", "showOnScrollUp", "transparentUntilScroll", "scrollThreshold"], defaultExpanded: false },
      { id: "mobile", label: "📱 Mobile Menu", fields: ["mobileBreakpoint", "mobileMenuStyle", "mobileMenuBackground", "mobileMenuTextColor", "mobileMenuAnimation", "mobileMenuDuration", "showMobileMenuOverlay", "mobileMenuOverlayColor", "mobileMenuOverlayOpacity", "hamburgerIcon", "hamburgerSize", "hamburgerColor", "showCtaInMobileMenu", "mobileMenuLinkSpacing"], defaultExpanded: false },
      { id: "scrollProgress", label: "📊 Scroll Progress", fields: ["showScrollProgress", "scrollProgressPosition", "scrollProgressHeight", "scrollProgressColor", "scrollProgressBackground", "scrollProgressStyle"], defaultExpanded: false },
      { id: "accessibility", label: "♿ Accessibility", fields: ["ariaLabel", "skipToContent"], defaultExpanded: false },
    ],
    defaultProps: {
      logoText: "Your Brand",
      logoLink: "/",
  ...
  defineComponent({
    ...
    fieldGroups: [
      { id: "branding", label: "🏷️ Logo & Branding", fields: ["logo", "logoText", "logoHeight", "companyName", "description", "tagline"], defaultExpanded: true },
      { id: "columns", label: "📋 Link Columns", fields: ["columns", "columnsLayout"], defaultExpanded: true },
      { id: "newsletter", label: "📧 Newsletter", fields: ["showNewsletter", "newsletterTitle", "newsletterDescription", "newsletterPlaceholder", "newsletterButtonText", "newsletterButtonColor"], defaultExpanded: false },
      { id: "social", label: "🌐 Social Links", fields: ["showSocialLinks", "socialLinksTitle", "socialLinks", "socialIconSize", "socialIconStyle"], defaultExpanded: false },
      { id: "contact", label: "📞 Contact Info", fields: ["showContactInfo", "contactTitle", "contactEmail", "contactPhone", "contactAddress"], defaultExpanded: false },
      { id: "appStores", label: "📱 App Store Badges", fields: ["showAppStores", "appStoreUrl", "playStoreUrl"], defaultExpanded: false },
      { id: "legal", label: "⚖️ Legal & Copyright", fields: ["copyright", "legalLinks", "showMadeWith", "madeWithText"], defaultExpanded: false },
      { id: "layout", label: "📐 Layout", fields: ["variant", "maxWidth", "paddingTop", "paddingBottom", "paddingX"], defaultExpanded: false },
      { id: "appearance", label: "🎨 Colors & Style", fields: ["backgroundColor", "textColor", "linkColor", "linkHoverColor", "borderTop", "borderColor", "dividerColor"], defaultExpanded: false },
    ],
    defaultProps: {
