...
import {
  ...
  GridItemRender,
  WrapperRender,
  AspectRatioBoxRender,
  OverlayRender,
  // Phase 3: Advanced Experiences
  ScrollSectionRender,
  ScrollSectionItemRender,
  StickyContainerRender,
  AnimateRender,
  Tilt3DContainerRender,
  ShapeDividerRender,
  CursorEffectRender,
...
const layoutComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    type: "Stack",
    label: "Stack",
    description: "Vertical or horizontal stack with responsive direction",
    category: "layout",
  ...
  defineComponent({
    type: "FlexBox",
    label: "FlexBox",
    description: "Full-featured flexbox container with wrap support",
    category: "layout",
    icon: "LayoutGrid",
    render: FlexBoxRender,
    acceptsChildren: true,
    isContainer: true,
    fields: {
      direction: {
  ...
  defineComponent({
    type: "GridItem",
    label: "Grid Item",
    description: "Grid child with span control",
    category: "layout",
    icon: "Square",
  ...
  defineComponent({
    type: "Wrapper",
    label: "Wrapper",
    description: "Utility wrapper with spacing and background control",
    category: "layout",
    icon: "Box",
    ...
    ai: {
      description: "A utility wrapper for adding spacing, background, and borders around content",
      canModify: ["padding", "margin", "backgroundColor", "borderRadius", "border", "linkHref"],
    },
  }),
  ...
  defineComponent({
    ...
    ai: {
      description: "A container that maintains a fixed aspect ratio regardless of content",
      canModify: ["ratio", "overflow", "backgroundColor"],
    },
  }),
  ...
  defineComponent({
    type: "Overlay",
    label: "Overlay",
    description: "Positioned overlay layer on parent content",
    category: "layout",
    icon: "Layers",
    ...
    fields: {
      ...
      backgroundColor: { type: "color", label: "Background Color" },
      backdropBlur: { type: "toggle", label: "Backdrop Blur", defaultValue: false },
      pointerEvents: {
        type: "select",
        label: "Pointer Events",
        options: [
          { label: "All (Clickable)", value: "auto" },
          { label: "None (Click-through)", value: "none" },
        ],
        defaultValue: "auto",
      },
      padding: {
    ...
    ai: {
      description: "A positioned overlay that floats on top of sibling content",
      canModify: ["position", "backgroundColor", "backdropBlur", "pointerEvents", "padding"],
    },
  }),
  ...
  defineComponent({
    ...
    description: "Full-page scroll-snap storytelling container",
    category: "layout",
    icon: "Layers",
    render: ScrollSectionRender,
    acceptsChildren: true,
    isContainer: true,
    fields: {
  ...
  defineComponent({
    ...
    category: "layout",
    icon: "Square",
    render: ScrollSectionItemRender,
    acceptsChildren: true,
    isContainer: true,
    fields: {
      backgroundColor: { type: "color", label: "Background Color" },
  ...
  defineComponent({
    ...
    description: "Interactive 3D tilt effect on hover",
    category: "layout",
    icon: "RotateCw",
    render: Tilt3DContainerRender,
    acceptsChildren: true,
    isContainer: true,
    fields: {
      maxTilt: {
  ...
  defineComponent({
    ...
    fields: {
      ...
      color: { type: "color", label: "Fill Color", defaultValue: "#ffffff" },
      height: {
        type: "number",
        label: "Height (px)",
        min: 20,
