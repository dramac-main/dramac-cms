...
const typographyComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    label: "Heading",
    description:
      "Heading text (H1-H6) with full typography controls, gradient, and CSS variable type scale",
    category: "typography",
    icon: "Heading",
    ...
    ai: {
      description:
        "A heading element with full typography controls, gradient text, and CSS variable type scale integration",
      canModify: [
        "text",
        "level",
        "align",
...
const mediaComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A draggable image comparison slider for showing before/after transformations — renovations, cosmetic work, photo editing, web design",
      canModify: [
        "beforeImage",
        "afterImage",
        "beforeLabel",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "An SVG icon display component using Lucide icons with optional background shapes and animations",
      canModify: [
        "name",
        "size",
        "color",
  ...
  defineComponent({
    ...
    category: "media",
    description:
      "Audio player with waveform visualisation, cover art, and playback controls",
    render: AudioRender,
    fields: {
    ...
    ai: {
      description:
        "An audio player with waveform visualisation, cover art, multiple variants (full/compact/minimal), and playback controls",
      canModify: [
        "src",
        "title",
        "artist",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A secure responsive iframe container for embedding external content like YouTube videos, Google Maps, or other web pages",
      canModify: [
        "src",
        "title",
        "aspectRatio",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A group of overlapping avatar circles showing team members or users, with a +N overflow count badge",
      canModify: [
        "avatars",
        "max",
        "size",
...
const formComponents: ComponentDefinition[] = [
  defineComponent({
    ...
    fieldGroups: [
      ...
      {
        id: "platformSubmission",
        label: "Platform Submission",
        icon: "Cloud",
        fields: ["enablePlatformSubmission", "formId"],
      },
      {
        id: "layout",
        label: "Layout",
  ...
  defineComponent({
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        icon: "Eye",
        fields: ["showPhone", "showSubject"],
      },
      {
        id: "appearance",
        label: "Appearance",
        icon: "Palette",
        fields: ["backgroundColor", "borderRadius", "shadow", "padding"],
      },
      {
        id: "colorOverrides",
        label: "Colours",
    ...
    fields: {
      ...
      buttonColor: { type: "color", label: "Button Colour" },
      buttonTextColor: {
        type: "color",
        label: "Button Text Colour",
        defaultValue: "#ffffff",
      },
      textColor: { type: "color", label: "Text Colour" },
      labelColor: { type: "color", label: "Label Colour" },
      inputBackgroundColor: { type: "color", label: "Input Background" },
      inputBorderColor: { type: "color", label: "Input Border" },
      inputTextColor: { type: "color", label: "Input Text Colour" },
    },
    defaultProps: {
      title: "Contact Us",
    ...
    ai: {
      description:
        "A pre-built contact form with name, email, phone, subject, and message fields. Supports full colour customisation and field label overrides.",
      canModify: [
        "title",
        "subtitle",
        "submitText",
  ...
  defineComponent({
    ...
    fieldGroups: [
      ...
      },
      {
        ...
        label: "Input Styling",
        icon: "Paintbrush",
        fields: ["inputBackgroundColor", "inputBorderColor", "inputTextColor"],
      },
    ],
    fields: {
      title: {
    ...
    ai: {
      description:
        "An email newsletter signup form with submission handling, honeypot spam protection, and success/error states",
      canModify: [
        "title",
        "description",
        "buttonText",
...
const contentComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A blockquote element with 6 variants for displaying quotes, testimonials, and pullquotes",
      canModify: [
        "text",
        "author",
        "authorTitle",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A small utility text element for tags, badges, categories, and overlines",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A styled list component with multiple marker variants including bullets, numbers, checkmarks, and arrows",
      canModify: [
        "items",
        "variant",
        "spacing",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "Large decorative display text for hero sections, splash pages, and dramatic headings with gradient support",
      canModify: [
        "text",
        "fontSize",
        "fontWeight",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A text element with decorative divider lines, useful for section separators and visual breaks",
  ...
  defineComponent({
    ...
    ai: {
      description:
        "A large statistic/metric display component with value, prefix, suffix, and label — uses tabular-nums for aligned numbers",
      canModify: [
        "value",
        "prefix",
        "suffix",
...
const uiComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    type: "Badge",
    label: "Badge",
    description: "Status badge with icons, animations, and color styling",
    category: "content",
    icon: "Tag",
    render: BadgeRender,
    fieldGroups: [
...
const effectsComponents: ComponentDefinition[] = [
  ...
  defineComponent({
    ...
    fieldGroups: [
      {
        ...
        label: "Header",
        icon: "Type",
        fields: ["title", "subtitle", "badge", "badgeColor", "headerAlign"],
      },
      {
        id: "layout",
        label: "Layout",
      ...
      },
      {
        ...
        label: "Image",
        icon: "Image",
        fields: ["imageAspectRatio", "imageRounded"],
      },
      {
        id: "cardStyle",
        label: "Card Style",
      ...
      },
      {
        ...
        label: "CTA",
        icon: "ExternalLink",
        fields: ["ctaText", "ctaLink", "ctaColor"],
      },
      {
        id: "spacing",
        label: "Spacing",
    ...
    defaultProps: {
      ...
      posts: [
        ...
        },
        {
          ...
          excerpt: "Tips for getting the most out of your site.",
          image: "",
          author: "Admin",
          date: "2025-01-10",
          category: "Guide",
        ...
        {
          title: "What's New",
          excerpt: "Check out our latest features and updates.",
          image: "",
          author: "Admin",
          date: "2025-01-05",
          category: "News",
    ...
    ai: {
      description:
        "Blog post preview section supporting grid, list, featured, or card layouts. Each post has image, category, title, excerpt, author with avatar, date, and read time. Section includes header with badge, CTA link, and responsive dark-mode-aware styling.",
      canModify: [
        "title",
        "subtitle",
        "badge",
