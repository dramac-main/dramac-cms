...
export const FALLBACK_PRICES: Record<string, FallbackPriceEntry> = {
  // --- Popular gTLDs ---
  '.com':  { register: { 1: 9.99,  2: 19.98 }, renew: { 1: 10.99 }, transfer: 9.99 },
  ...
  '.network':  { register: { 1: 19.99, 2: 39.98 },  renew: { 1: 22.99 },  transfer: 19.99 },
  ...
  '.graphics':    { register: { 1: 19.99, 2: 39.98 }, renew: { 1: 22.99 },  transfer: 19.99 },
  ...
  '.fr':    { register: { 1: 9.99,  2: 19.98 }, renew: { 1: 11.99 }, transfer: 9.99 },
  '.africa':{ register: { 1: 15.99, 2: 31.98 }, renew: { 1: 17.99 }, transfer: 15.99 },
  ...
  // --- Professional ---
  '.expert':   { register: { 1: 39.99, 2: 79.98 }, renew: { 1: 49.99 }, transfer: 39.99 },
  '.academy':  { register: { 1: 25.99, 2: 51.98 }, renew: { 1: 29.99 }, transfer: 25.99 },
  '.training': { register: { 1: 25.99, 2: 51.98 }, renew: { 1: 29.99 }, transfer: 25.99 },
};

/** Default fallback price for TLDs not in the dictionary */
