      ...
      },
      {
        ...
        props: {
          ...
          fields: [
            ...
            { name: "budget", label: "Budget Range", type: "select", options: ["<K100k", "K100k-250k", "K250k-500k", "K500k+"], required: true },
    ...
    content: [
      ...
      },
      {
        ...
        props: {
          ...
          services: [
            { icon: "📸", title: "Portrait Session", description: "1-hour session, 20 edited photos", price: "From K3,500" },
            { icon: "💒", title: "Wedding Photography", description: "Full day coverage, unlimited photos", price: "From K30,000" },
            { icon: "👨‍👩‍👧", title: "Family & Lifestyle", description: "On-location session, 30 edited photos", price: "From K5,000" },
      ...
      },
      {
        ...
        props: {
          id: generateId(),
          companyName: "YOUR NAME PHOTOGRAPHY",
          showSocial: true,
          socialLinks: { instagram: "#", pinterest: "#" },
          copyrightText: "© 2026 Your Name Photography. All rights reserved.",
          backgroundColor: "#ffffff",
          textColor: "#171717",
        },
      },
    ...
    content: [
      ...
      },
      {
        ...
        props: {
          ...
          copyrightText: "© 2026 Your Name. Built with Next.js",
          backgroundColor: "#0f172a",
          textColor: "#94a3b8",
        },
      },
