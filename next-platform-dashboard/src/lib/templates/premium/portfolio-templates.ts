      ...
      },
      {
        ...
        props: {
          ...
          fields: [
            ...
            { name: "budget", label: "Budget Range", type: "select", options: ["<$100k", "$100k-250k", "$250k-500k", "$500k+"], required: true },
    ...
    content: [
      ...
      },
      {
        ...
        props: {
          ...
          services: [
            { icon: "📸", title: "Portrait Session", description: "1-hour session, 20 edited photos", price: "From $3,500" },
            { icon: "💒", title: "Wedding Photography", description: "Full day coverage, unlimited photos", price: "From $30,000" },
            { icon: "👨‍👩‍👧", title: "Family & Lifestyle", description: "On-location session, 30 edited photos", price: "From $5,000" },
