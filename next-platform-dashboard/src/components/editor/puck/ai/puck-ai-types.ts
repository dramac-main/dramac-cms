/**
 * Puck AI Types and Constants
 * 
 * Client-safe types, constants, and utilities for AI-powered editing.
 * This file contains NO server-side dependencies and is safe for browser use.
