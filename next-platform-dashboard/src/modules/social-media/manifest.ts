...
export const MODULE_NAVIGATION = {
  ...
  subMenu: [
    { label: 'Dashboard', href: '/dashboard/sites/[siteId]/social', icon: 'LayoutDashboard' },
    { label: 'Calendar', href: '/dashboard/sites/[siteId]/social/calendar', icon: 'Calendar' },
    { label: 'Compose', href: '/dashboard/sites/[siteId]/social/compose', icon: 'PenSquare' },
    { label: 'Posts', href: '/dashboard/sites/[siteId]/social/posts', icon: 'FileText' },
    { label: 'Inbox', href: '/dashboard/sites/[siteId]/social/inbox', icon: 'Inbox' },
    { label: 'Analytics', href: '/dashboard/sites/[siteId]/social/analytics', icon: 'BarChart3' },
    { label: 'Campaigns', href: '/dashboard/sites/[siteId]/social/campaigns', icon: 'Target' },
    { label: 'Media', href: '/dashboard/sites/[siteId]/social/media', icon: 'Image' },
    { label: 'Listening', href: '/dashboard/sites/[siteId]/social/listening', icon: 'Ear' },
    { label: 'Competitors', href: '/dashboard/sites/[siteId]/social/competitors', icon: 'Users' },
    { label: 'Reports', href: '/dashboard/sites/[siteId]/social/reports', icon: 'FileBarChart' },
    { label: 'Accounts', href: '/dashboard/sites/[siteId]/social/accounts', icon: 'Link' },
    { label: 'Settings', href: '/dashboard/sites/[siteId]/social/settings', icon: 'Settings' },
  ],
}
