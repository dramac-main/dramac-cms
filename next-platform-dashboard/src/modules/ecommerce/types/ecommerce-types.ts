...
export type CategoryInput = Omit<
  Category,
  "id" | "created_at" | "updated_at" | "children" | "products" | "parent"
>;
...
export type ProductInput = Omit<
  Product,
  "id" | "created_at" | "updated_at" | "categories" | "variants" | "options"
>;
...
export type CartItemInput = Omit<
  CartItem,
  "id" | "created_at" | "product" | "variant"
>;
export type CartItemUpdate = Partial<
  Pick<CartItem, "quantity" | "custom_options">
>;
...
export type EcommerceSettingsInput = Omit<
  EcommerceSettings,
 ...
 */
export type QuoteTemplateUpdate = Partial<
  Omit<QuoteTemplateInput, "site_id" | "agency_id">
>;

/**
 * Input type for quote settings
 */
export type QuoteSettingsInput = Omit<
  QuoteSettings,
  "id" | "created_at" | "updated_at"
>;
export type QuoteSettingsUpdate = Partial<
  Omit<QuoteSettingsInput, "site_id" | "agency_id">
>;
