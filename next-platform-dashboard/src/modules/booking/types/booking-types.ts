...
export type StaffInput = Omit<
  Staff,
  "id" | "created_at" | "updated_at" | "services" | "calendar"
>;
...
export type StaffServiceInput = Omit<
  StaffService,
  "id" | "created_at" | "staff" | "service"
>;
...
export type CalendarInput = Omit<
  Calendar,
  "id" | "created_at" | "updated_at" | "staff" | "availability"
>;
...
export type AppointmentInput = Omit<
  Appointment,
  "id" | "created_at" | "updated_at" | "service" | "staff" | "reminders"
>;
...
export type BookingSettingsInput = Omit<
  BookingSettings,
