...
export function BookingProvider({
  ...
  const [settings, setSettings] = useState<BookingSettings | null>(
  ...
  const addService = useCallback(
    async (input: Partial<ServiceInput>): Promise<Service> => {
  ...
  const editService = useCallback(
    async (id: string, updates: ServiceUpdate): Promise<Service> => {
  ...
  const addStaff = useCallback(
    async (input: Partial<StaffInput>): Promise<Staff> => {
  ...
  const editStaff = useCallback(
    async (id: string, updates: StaffUpdate): Promise<Staff> => {
  ...
  const addAppointment = useCallback(
    async (input: Partial<AppointmentInput>): Promise<Appointment> => {
  ...
  const editAppointment = useCallback(
    async (id: string, updates: AppointmentUpdate): Promise<Appointment> => {
  ...
  const cancelAppointment = useCallback(
    async (
      ...
      const appointment = await cancelAppointmentAction(
        siteId,
        id,
        cancelledBy,
        reason,
  ...
  const addCalendar = useCallback(
    async (input: Partial<CalendarInput>): Promise<Calendar> => {
  ...
  const editCalendar = useCallback(
    async (id: string, updates: CalendarUpdate): Promise<Calendar> => {
