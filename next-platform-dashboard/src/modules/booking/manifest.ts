...
export const BookingModuleManifest: ModuleManifest = {
  ...
  description:
    "Appointment scheduling, calendar management, and online booking widget with CRM integration",
  version: "1.0.0",
  ...
  features: [
    {
      ...
      description:
        "Create and manage bookable services with pricing and duration",
      enabled: true,
    },
    {
      id: "staff-management",
