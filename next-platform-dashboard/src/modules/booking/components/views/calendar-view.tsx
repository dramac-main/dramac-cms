        ...
        <CardHeader className="pb-3">
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <h3 className="font-semibold">
              {viewMode === "week" ? (
                <>
                  {weekDates[0].toLocaleDateString(DEFAULT_LOCALE, {
                    month: "long",
                    year: "numeric",
                  })}
                  {weekDates[0].getMonth() !== weekDates[6].getMonth() && (
                    <>
                      {" "}
                      -{" "}
                      {weekDates[6].toLocaleDateString(DEFAULT_LOCALE, {
                        month: "long",
                        year: "numeric",
                      })}
                    </>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="text-sm opacity-75">
                                {startTime.toLocaleTimeString(DEFAULT_LOCALE, {
                                  hour: "numeric",
                                  minute: "2-digit",
                                })}{" "}
                                -{" "}
                                {endTime.toLocaleTimeString(DEFAULT_LOCALE, {
                                  hour: "numeric",
                                  minute: "2-digit",
                                })}
                              </div>
