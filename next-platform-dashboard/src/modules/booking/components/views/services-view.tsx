...
export function ServicesView({
  ...
  const { services, isLoading, editService, removeService, refreshAll } =
    useBooking();
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="font-medium">
                          {formatPrice(
                            service.price ?? 0,
                            service.currency || DEFAULT_CURRENCY,
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
                        ...
                        0 ? (
                          <span className="text-sm text-muted-foreground">
                            {service.buffer_before_minutes || 0}m /{" "}
                            {service.buffer_after_minutes || 0}m
                          </span>
                        ) : (
                          <span className="text-muted-foreground">—</span>
                        )}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete &ldquo;{deletingService?.name}
