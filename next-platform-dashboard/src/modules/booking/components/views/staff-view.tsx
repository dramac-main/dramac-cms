...
export function StaffView({
  ...
  const { staff, services, isLoading, editStaff, removeStaff, refreshAll } =
    useBooking();
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t">
                            <Badge
                              variant={
                                staffMember.is_active ? "default" : "secondary"
                              }
                              className={cn(
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete &ldquo;{deletingStaff?.name}
