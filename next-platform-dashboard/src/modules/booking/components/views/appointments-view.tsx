                      ...
                      <TableCell>
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-muted-foreground flex items-center gap-1">
                            ...
                            {formatTime(
                              getTimeFromTimestamp(apt.start_time),
                              settings?.time_format,
                            )}{" "}
                            -{" "}
                            {formatTime(
                              getTimeFromTimestamp(apt.end_time),
                              settings?.time_format,
                            )}
                          </span>
                        </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this appointment for &ldquo;
              {deletingApt?.customer_name}&rdquo;? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
