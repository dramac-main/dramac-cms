...
import { Clock, Coins, Tag, Edit, Trash2, Timer, Users } from "lucide-react";
...
export function ServiceDetailSheet({
  ...
  const completedCount = serviceAppointments.filter(
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 rounded-lg border">
              ...
              <p className="text-xl font-bold">
                {formatCurrency(service.price ?? 0, service.currency)}
              </p>
            </div>
            <div className="p-3 rounded-lg border">
              <div className="flex items-center gap-2 text-muted-foreground mb-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">
                    {service.buffer_before_minutes || 0} min
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">After</p>
                  <p className="font-medium">
                    {service.buffer_after_minutes || 0} min
                  </p>
                </div>
              </div>
            </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to delete &ldquo;{service.name}
