...
export function StaffDetailSheet({
  ...
  // Calculate stats
  const { completedCount, upcomingCount, totalCount, completionRate } =
    useMemo(() => {
  ...
  const handleToggleStatus = async () => {
    try {
      ...
      toast.success(
        `Staff member ${staffMember.is_active ? "deactivated" : "activated"}`,
      );
    } catch {
      ...
      <SheetContent className="sm:max-w-[480px] overflow-y-auto">
        ...
        <div className="mt-6 space-y-6">
          ...
          {staffMember.working_hours &&
            Object.keys(staffMember.working_hours).length > 0 && (
              <>
                <Separator />
                <div className="space-y-3">
                  <h4 className="font-medium text-sm text-muted-foreground flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      const hours =
                        staffMember.working_hours?.[
                          day as keyof typeof staffMember.working_hours
                        ];
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to delete &ldquo;{staffMember.name}
