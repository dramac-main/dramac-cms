...
const DEMO_STAFF: StaffMember[] = [
  {
    ...
    bio: "Certified massage therapist with over 10 years of experience in deep tissue and Swedish massage techniques.",
    rating: 4.9,
    reviewCount: 124,
  ...
  },
  {
    ...
    bio: "Expert in sports massage and rehabilitation therapy. Former physiotherapist turned wellness professional.",
    rating: 4.8,
    reviewCount: 89,
    specialties: ["Sports Massage", "Rehabilitation", "Cupping"],
  ...
  },
  {
    ...
    bio: "Licensed esthetician specializing in anti-aging treatments and organic skincare solutions.",
    rating: 4.7,
    reviewCount: 67,
    specialties: ["Facials", "Anti-Aging", "Organic Skincare"],
  ...
  },
  {
    ...
    name: "David Park",
    role: "Hair Stylist",
    bio: "Award-winning hair stylist with expertise in cutting-edge techniques and color correction.",
    rating: 4.6,
    reviewCount: 201,
...
export function StaffGridBlock({
  ...
  const filteredStaff = useMemo(() => {
    let staff = dataStaff;
    if (activeSpecialty)
      staff = staff.filter((s) => s.specialties.includes(activeSpecialty));
    if (searchQuery) {
                ...
                onMouseEnter={(e) => {
                  if (animateCards) {
                    (e.currentTarget as HTMLElement).style.boxShadow =
                      SHADOW_MAP[hoverShadow] || SHADOW_MAP.md;
                    if (hoverScale)
              ...
              >
                ...
                {showAvatar && (
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      margin:
                        !isList && contentAlignment === "center"
                          ? "0 auto 12px"
                          : isList
                            ? 0
                            : "0 0 12px",
                  ...
                  {showRating && staff.rating > 0 && (
                    <div
                      style={{
                        ...
                        marginBottom: "8px",
                        justifyContent:
                          contentAlignment === "center" && !isList
                            ? "center"
                            : undefined,
                      }}
                    >
                      ...
                      {showReviewCount && (
                        <span
                          style={{ fontSize: ratingFontSize, opacity: 0.5 }}
                        >
                  ...
                  {showAvailability && (
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        gap: "6px",
                        marginBottom: showBookButton ? "10px" : 0,
                        justifyContent:
                          contentAlignment === "center" && !isList
                            ? "center"
                            : undefined,
                    ...
                    >
                      ...
                      />
                      <span
                        style={{ fontSize: availabilityFontSize, opacity: 0.6 }}
                      >
                        {staff.bookable
                          ? `${availableLabel} · ${staff.availability}`
                          : unavailableLabel}
                      </span>
                    </div>
                  )}
                ...
                {showBookButton && (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (staff.bookable && buttonHoverColor)
...
export const staffGridDefinition: ComponentDefinition = {
  ...
  label: "Staff Grid",
  description:
    "Display team members with bio, rating, specialties, and book button — 50+ customization options. Use instead of generic Team component for booking-enabled businesses.",
  category: "content",
  icon: "Users",
  keywords: [
    "staff",
  ...
  fieldGroups: [
    ...
    },
    {
      ...
      icon: "Database",
      fields: ["staffId", "maxStaff", "filterBySpecialty", "sortBy"],
      defaultExpanded: true,
    },
    {
      id: "layout",
  ...
  ai: {
    description:
      "Staff team grid with ratings, specialties, and booking — 50+ properties",
    canModify: [
      "title",
      "subtitle",
      "layout",
