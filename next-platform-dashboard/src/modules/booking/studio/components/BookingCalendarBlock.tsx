...
function resolveResponsive<T>(
  ...
  if (
    typeof val === "object" &&
    val !== null &&
    ("mobile" in val || "tablet" in val || "desktop" in val)
  ) {
    return (
      (val as any).desktop ??
      (val as any).tablet ??
...
export function BookingCalendarBlock({
  ...
  const { slots: realSlots, isLoading: isLoadingRealSlots } = useBookingSlots(
    siteId || "",
    {
  ...
  const formatTime = (hour: number, min: number): string =>
    formatTimeHelper(hour, min, timeFormat);
  ...
  const resolvedTitleFontSize = resolveResponsive(
    titleFontSize,
          ...
          >
            {dayNames.map((day) => (
              <div
                ...
                style={{
                  textAlign: "center",
                  fontSize: dayFontSize || (isCompact ? "11px" : "13px"),
                  fontWeight: 500,
                  opacity: 0.6,
                  padding: "4px 0",
                }}
                ...
                {date && (
                  <button
                    ...
                    style={{
                      ...
                      transform:
                        hoverScale && isSelected(date)
                          ? "scale(1.05)"
                          : undefined,
                    }}
                    onMouseEnter={(e) => {
                      if (!isPast(date) && !isSelected(date))
                    ...
                    {timeSlots.map((slot) => (
                      <button
                        ...
                        style={{
                          ...
                          fontSize:
                            timeFontSize || (isCompact ? "12px" : "13px"),
...
export const bookingCalendarDefinition: ComponentDefinition = {
  ...
  description:
    "Interactive calendar for selecting appointment dates and times — 50+ customization options",
  ...
  fields: {
    ...
    showTimeSlots: {
      ...
      description: "Display time slot picker after date selection",
    },
    showLegend: {
      type: "toggle",
      label: "Show Legend",
      description: "Show available/unavailable legend",
    },
    ...
    dateFormat: {
      ...
      options: [
        ...
        { label: "Medium (Mon, Jan 5)", value: "medium" },
        { label: "Long (Monday, January 5, 2026)", value: "long" },
      ],
    },
  ...
  fieldGroups: [
    ...
    },
    {
      ...
      label: "Navigation",
      icon: "Navigation",
      fields: ["showNavArrows", "showMonthYear", "showTodayButton"],
      defaultExpanded: false,
    },
    {
      id: "colors",
  ...
  ai: {
    description:
      "Interactive booking calendar — fully customizable with 50+ properties",
    canModify: [
      "title",
      "subtitle",
      "showHeader",
