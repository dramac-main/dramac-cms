  ...
  if (!siteId && !embedUrl) {
    return (
      ...
      >
        ...
        >
          <Calendar
            style={{ width: 28, height: 28, color: noSiteIcon, opacity: 0.6 }}
          />
        </div>
        <h3
          style={{
        ...
        <button
          style={{
            padding: btnSizes[buttonSize],
            borderRadius: buttonBorderRadius,
            backgroundColor: btnBg,
            color: resolvedBtnText,
            border: "none",
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              backgroundColor:
                activeTab === tab.id ? activeTabBg : "transparent",
              color: activeTab === tab.id ? activeTabColor : inactiveTab,
              border: "none",
              fontSize: tabFontSize,
              fontWeight: activeTab === tab.id ? "600" : tabFontWeight,
              cursor: "pointer",
              display: "flex",
              alignItems: "center",
              gap: "6px",
        ...
        {activeTab === "preview" ? (
          embedType === "popup" ? (
            <div style={{ textAlign: "center", padding: "40px 20px" }}>
              ...
              >
                Click the button below to preview the popup booking widget.
              </p>
              <button
                onClick={() =>
                  window.open(resolvedUrl, "booking", "width=500,height=700")
...
export const bookingEmbedDefinition: ComponentDefinition = {
  ...
  label: "Booking Embed",
  description:
    "Embeddable booking widget with preview and embed code — 50+ customization options",
  ...
  fieldGroups: [
    ...
    },
    {
      ...
      fields: ["buttonText", "buttonIcon", "buttonSize"],
    ...
    },
    {
      ...
      label: "Layout",
      icon: "Layout",
      fields: ["headerAlignment", "width", "minHeight", "padding", "gap"],
      defaultExpanded: false,
    },
    {
      id: "colors",
  ...
  ai: {
    description:
      "Embeddable booking widget with preview and code — 50+ customization options",
    canModify: [
      "title",
      "subtitle",
      "embedType",
