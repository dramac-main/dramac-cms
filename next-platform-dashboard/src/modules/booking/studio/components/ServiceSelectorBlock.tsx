...
const DEMO_SERVICES: ServiceItem[] = [
  {
    ...
    description:
      "Relaxing full body massage therapy to relieve stress and tension.",
    duration: 60,
    price: 85,
  ...
  },
  {
    ...
    description:
      "Intensive massage targeting deep muscle layers for pain relief.",
    duration: 90,
    price: 120,
    currency: DEFAULT_CURRENCY,
    category: "Massage",
  ...
  },
  {
    ...
    name: "Hair Styling",
    description:
      "Professional hair styling and consultation with expert stylists.",
    duration: 30,
    price: 45,
    currency: DEFAULT_CURRENCY,
    category: "Hair",
  ...
  },
  {
    ...
    description:
      "Essential oil therapy session for deep relaxation and healing.",
    duration: 60,
    price: 95,
    currency: DEFAULT_CURRENCY,
    category: "Wellness",
...
export function ServiceSelectorBlock({
  ...
  const { services: realServices, isLoading } = useBookingServices(
    siteId || "",
  );
  ...
  const selectedBg = cardSelectedBgColor || `${pc}08`;
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    cursor:
                      service.available === false ? "not-allowed" : "pointer",
                    ...
                    if (animateCards) {
                      ...
                      if (hoverScale)
                        (e.currentTarget as HTMLElement).style.transform =
                          "none";
                      (e.currentTarget as HTMLElement).style.backgroundColor =
                        isActive ? selectedBg : cardBackgroundColor || "";
                    }
                  }}
                  role="button"
                        ...
                        paddingTop:
                          imageAspectRatio === "square"
                            ...
                            : imageAspectRatio === "landscape"
                              ...
                              : "75%",
                        position: "relative",
                        borderRadius: `${imageBorderRadius || cardBorderRadius} ${imageBorderRadius || cardBorderRadius} 0 0`,
                        overflow: "hidden",
                        marginBottom: "12px",
                        marginTop: layout === "list" ? 0 : `-${cardPadding}`,
                        marginLeft:
                          layout === "list"
                            ? `-${cardPadding}`
                            : `-${cardPadding}`,
                        marginRight:
                          layout === "list" ? "0" : `-${cardPadding}`,
                        width:
                          layout === "list"
                            ? "120px"
                            : `calc(100% + 2 * ${cardPadding})`,
                        flexShrink: 0,
                      }}
                    >
                      <img
                  ...
                  {showCategory && service.category && layout !== "list" && (
                    <span
                      style={{
                        ...
                        borderRadius: "4px",
                        marginBottom: "8px",
                        backgroundColor: categoryBgColor || `${pc}10`,
                    ...
                    >
                      ...
                      {showRating && service.rating && (
                        ...
                        >
                          ...
                          />
                          <span style={{ color: ratingClr, fontWeight: 500 }}>
                            {service.rating}
                          </span>
                          {service.reviewCount && (
                  ...
                  >
                    ...
                    <button
                      style={{
                        padding: "6px 16px",
                        borderRadius: buttonBorderRadius,
                        backgroundColor: isActive ? `${pc}20` : btnBg,
...
export const serviceSelectorDefinition: ComponentDefinition = {
  ...
  description:
    "Display bookable services in grid, list, or card layout — 50+ customization options. Use on services pages for booking-enabled businesses.",
  ...
  fieldGroups: [
    ...
    },
    {
      ...
      icon: "Database",
      fields: ["serviceId", "maxServices", "filterByCategory"],
      defaultExpanded: true,
    },
    {
      id: "layout",
  ...
  ai: {
    description:
      "Service selection catalog with prices, ratings, and categories — 50+ properties",
    canModify: [
      "title",
      "subtitle",
      "layout",
