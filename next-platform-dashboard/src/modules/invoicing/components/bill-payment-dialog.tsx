...
import type { BillPaymentInput } from "../actions/bill-actions";
import { recordBillPayment } from "../actions/bill-actions";
...
export function BillPaymentDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await recordBillPayment(billId, input);
      setOpen(false);
      onSuccess?.();
    } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="bill-pay-amount">Amount</Label>
              <Input
                id="bill-pay-amount"
                type="number"
                step="0.01"
            ...
            {/* Date */}
            <div className="space-y-2">
              <Label htmlFor="bill-pay-date">Payment Date</Label>
              <Input
                id="bill-pay-date"
                type="date"
                value={paymentDate}
