...
export type WorkflowVariableInput = Omit<
  WorkflowVariable,
  "id" | "created_at" | "updated_at"
>;
...
export type EventSubscriptionInput = Omit<
  EventSubscription,
  "id" | "created_at" | "updated_at" | "events_received" | "last_event_at"
>;
...
export type ScheduledJobInput = Omit<
  ScheduledJob,
  | "id"
  | "created_at"
  | "updated_at"
...
export type AutomationConnectionInput = Omit<
  AutomationConnection,
  "id" | "created_at" | "updated_at" | "last_used_at" | "last_error"
>;
...
export type WebhookEndpointInput = Omit<
  WebhookEndpoint,
  "id" | "created_at" | "total_calls" | "last_called_at"
>;
