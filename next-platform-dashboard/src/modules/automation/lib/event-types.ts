...
export const EVENT_CATEGORIES = [
  {
    ...
    name: "CRM",
    icon: "User",
    description: "Contact, company, deal, and activity events",
  },
  {
    id: "booking",
    name: "Booking",
    icon: "Calendar",
    description: "Appointment and scheduling events",
  },
  {
    id: "form",
    name: "Forms",
    icon: "FileText",
    description: "Form submission and creation events",
  },
  {
    id: "accounting",
    name: "Accounting",
    icon: "CircleDollarSign",
    description: "Invoice, payment, and expense events",
  },
  {
    id: "ecommerce",
    name: "E-Commerce",
    icon: "ShoppingCart",
    description: "Order, cart, product, and quote events",
  },
  {
    id: "live_chat",
    name: "Live Chat",
    icon: "MessageSquare",
    description: "Conversation, message, and agent events",
  },
  {
    id: "domain",
    name: "Domains",
    icon: "Globe",
    description: "Domain registration, DNS, email, and transfer events",
  },
  {
    id: "billing",
    name: "Billing",
    icon: "CreditCard",
    description: "Subscription, payment, and usage events",
  },
  {
    id: "system",
    name: "System",
    icon: "Settings",
    description: "Webhook, schedule, and module events",
  },
  {
    id: "automation",
    name: "Automation",
  ...
  },
  {
    ...
    name: "AI Agents",
    icon: "Bot",
    description: "AI agent execution and approval events",
  },
] as const;
...
export function getAllEventDefinitions(): EventDefinition[] {
  ...
  events.push(
    {
      id: EVENT_REGISTRY.crm.contact.created,
      category: "crm",
      entity: "contact",
      action: "created",
    ...
    {
      id: EVENT_REGISTRY.crm.contact.updated,
      category: "crm",
      entity: "contact",
      action: "updated",
    ...
    {
      id: EVENT_REGISTRY.crm.contact.deleted,
      category: "crm",
      entity: "contact",
      action: "deleted",
    ...
    {
      id: EVENT_REGISTRY.crm.contact.tag_added,
      category: "crm",
      entity: "contact",
      action: "tag_added",
    ...
    {
      id: EVENT_REGISTRY.crm.contact.tag_removed,
      category: "crm",
      entity: "contact",
      action: "tag_removed",
    ...
    {
      id: EVENT_REGISTRY.crm.company.created,
      category: "crm",
      entity: "company",
      action: "created",
    ...
    {
      id: EVENT_REGISTRY.crm.company.updated,
      category: "crm",
      entity: "company",
      action: "updated",
    ...
    {
      id: EVENT_REGISTRY.crm.deal.created,
      category: "crm",
      entity: "deal",
      action: "created",
      name: "Deal Created",
    ...
    {
      id: EVENT_REGISTRY.crm.deal.stage_changed,
      category: "crm",
      entity: "deal",
    ...
    {
      id: EVENT_REGISTRY.crm.deal.won,
      category: "crm",
      entity: "deal",
      action: "won",
      name: "Deal Won",
    ...
    {
      id: EVENT_REGISTRY.crm.deal.lost,
      category: "crm",
      entity: "deal",
      action: "lost",
      name: "Deal Lost",
    ...
    {
      id: EVENT_REGISTRY.crm.task.created,
      category: "crm",
      entity: "task",
      action: "created",
      name: "Task Created",
    ...
    {
      id: EVENT_REGISTRY.crm.task.completed,
      category: "crm",
      entity: "task",
      action: "completed",
      name: "Task Completed",
    ...
    {
      id: EVENT_REGISTRY.crm.activity.logged,
      category: "crm",
      entity: "activity",
      action: "logged",
  ...
  events.push(
    {
      id: EVENT_REGISTRY.booking.appointment.created,
      category: "booking",
      entity: "appointment",
      action: "created",
      name: "Appointment Created",
      description: "Triggered when a new appointment is booked",
    },
    {
      id: EVENT_REGISTRY.booking.appointment.confirmed,
      category: "booking",
      entity: "appointment",
      action: "confirmed",
    ...
    {
      id: EVENT_REGISTRY.booking.appointment.cancelled,
      category: "booking",
      entity: "appointment",
      action: "cancelled",
    ...
    {
      id: EVENT_REGISTRY.booking.appointment.rescheduled,
      category: "booking",
      entity: "appointment",
      action: "rescheduled",
    ...
    {
      id: EVENT_REGISTRY.booking.appointment.completed,
      category: "booking",
      entity: "appointment",
      action: "completed",
    ...
    {
      id: EVENT_REGISTRY.booking.appointment.no_show,
      category: "booking",
      entity: "appointment",
      action: "no_show",
      name: "Appointment No-Show",
      description: "Triggered when a client does not show up",
    },
    {
      id: EVENT_REGISTRY.booking.appointment.reminder_sent,
      category: "booking",
      entity: "appointment",
      action: "reminder_sent",
      name: "Reminder Sent",
      description: "Triggered when an appointment reminder is sent",
    },
    {
      id: EVENT_REGISTRY.booking.appointment.payment_received,
      category: "booking",
      entity: "appointment",
      action: "payment_received",
      name: "Booking Payment Received",
      description: "Triggered when a booking payment is received",
    },
  );
  ...
  events.push(
    {
      id: EVENT_REGISTRY.form.submission.received,
      category: "form",
      entity: "submission",
      action: "received",
      name: "Form Submitted",
    ...
    {
      id: EVENT_REGISTRY.form.submission.processed,
      category: "form",
      entity: "submission",
      action: "processed",
      name: "Submission Processed",
      description: "Triggered after a submission is processed",
    },
    {
      id: EVENT_REGISTRY.form.submission.spam_detected,
      category: "form",
      entity: "submission",
      action: "spam_detected",
      name: "Spam Detected",
      description: "Triggered when spam is detected in a submission",
    },
  );
  ...
  events.push(
    {
      id: EVENT_REGISTRY.ecommerce.order.created,
      category: "ecommerce",
      entity: "order",
      action: "created",
      name: "Order Created",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.paid,
      category: "ecommerce",
      entity: "order",
      action: "paid",
      name: "Order Paid",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.shipped,
      category: "ecommerce",
      entity: "order",
      action: "shipped",
      name: "Order Shipped",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.delivered,
      category: "ecommerce",
      entity: "order",
      action: "delivered",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.cancelled,
      category: "ecommerce",
      entity: "order",
      action: "cancelled",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.refunded,
      category: "ecommerce",
      entity: "order",
      action: "refunded",
      name: "Order Refunded",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.cart.abandoned,
      category: "ecommerce",
      entity: "cart",
      action: "abandoned",
      name: "Cart Abandoned",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.product.low_stock,
      category: "ecommerce",
      entity: "product",
      action: "low_stock",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.product.out_of_stock,
      category: "ecommerce",
      entity: "product",
      action: "out_of_stock",
      name: "Out of Stock",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.order.status_changed,
      category: "ecommerce",
      entity: "order",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.payment.received,
      category: "ecommerce",
      entity: "payment",
      action: "received",
      name: "Payment Received",
      description: "Triggered when a payment is received for an order",
    },
    {
      id: EVENT_REGISTRY.ecommerce.payment.proof_uploaded,
      category: "ecommerce",
      entity: "payment",
      action: "proof_uploaded",
      name: "Payment Proof Uploaded",
      description: "Triggered when a customer uploads payment proof",
    },
    {
      id: EVENT_REGISTRY.ecommerce.payment.proof_rejected,
      category: "ecommerce",
      entity: "payment",
      action: "proof_rejected",
      name: "Payment Proof Rejected",
      description: "Triggered when uploaded payment proof is rejected",
    },
    {
      id: EVENT_REGISTRY.ecommerce.payment.updated,
      category: "ecommerce",
      entity: "payment",
      action: "updated",
      name: "Payment Updated",
      description: "Triggered when a payment record is updated",
    },
    {
      id: EVENT_REGISTRY.ecommerce.quote.created,
      category: "ecommerce",
      entity: "quote",
      action: "created",
      name: "Quote Created",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.quote.sent,
      category: "ecommerce",
      entity: "quote",
      action: "sent",
      name: "Quote Sent",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.quote.resent,
      category: "ecommerce",
      entity: "quote",
      action: "resent",
      name: "Quote Resent",
      description: "Triggered when a quote is resent to a customer",
    },
    {
      id: EVENT_REGISTRY.ecommerce.quote.reminder_sent,
      category: "ecommerce",
      entity: "quote",
      action: "reminder_sent",
      name: "Quote Reminder Sent",
      description: "Triggered when a quote reminder is sent",
    },
    {
      id: EVENT_REGISTRY.ecommerce.quote.accepted,
      category: "ecommerce",
      entity: "quote",
      action: "accepted",
      name: "Quote Accepted",
    ...
    {
      id: EVENT_REGISTRY.ecommerce.quote.rejected,
      category: "ecommerce",
      entity: "quote",
      action: "rejected",
      name: "Quote Rejected",
      description: "Triggered when a customer rejects a quote",
    },
    {
      id: EVENT_REGISTRY.ecommerce.quote.amendment_requested,
      category: "ecommerce",
      entity: "quote",
      action: "amendment_requested",
      name: "Quote Amendment Requested",
      description: "Triggered when a customer requests changes to a quote",
    },
    {
      id: EVENT_REGISTRY.ecommerce.quote.converted_to_order,
      category: "ecommerce",
      entity: "quote",
      action: "converted_to_order",
      name: "Quote Converted to Order",
      description: "Triggered when a quote is converted into an order",
    },
  );
  ...
  events.push(
    {
      id: EVENT_REGISTRY.live_chat.conversation.started,
      category: "live_chat",
      entity: "conversation",
      action: "started",
      name: "Chat Started",
      description: "Triggered when a new live chat conversation starts",
    },
    {
      id: EVENT_REGISTRY.live_chat.conversation.resolved,
      category: "live_chat",
      entity: "conversation",
      action: "resolved",
      name: "Chat Resolved",
      description: "Triggered when a live chat conversation is resolved",
    },
    {
      id: EVENT_REGISTRY.live_chat.conversation.closed,
      category: "live_chat",
      entity: "conversation",
      action: "closed",
      name: "Chat Closed",
      description: "Triggered when a live chat conversation is closed",
    },
    {
      id: EVENT_REGISTRY.live_chat.conversation.missed,
      category: "live_chat",
      entity: "conversation",
      action: "missed",
      name: "Chat Missed",
      description:
        "Triggered when a live chat conversation is missed (no agent response)",
    },
    {
      id: EVENT_REGISTRY.live_chat.conversation.assigned,
      category: "live_chat",
      entity: "conversation",
      action: "assigned",
      name: "Chat Assigned",
      description:
        "Triggered when a live chat conversation is assigned to an agent",
    },
    {
      id: EVENT_REGISTRY.live_chat.message.received,
      category: "live_chat",
      entity: "message",
      action: "received",
      name: "Chat Message Received",
      description: "Triggered when a new message is received in live chat",
    },
    {
      id: EVENT_REGISTRY.live_chat.message.agent_mentioned,
      category: "live_chat",
      entity: "message",
      action: "agent_mentioned",
      name: "Agent Mentioned",
      description: "Triggered when an agent is mentioned in a chat message",
    },
  );
  ...
  events.push(
    {
      id: EVENT_REGISTRY.billing.subscription.created,
      category: "billing",
      entity: "subscription",
      action: "created",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.activated,
      category: "billing",
      entity: "subscription",
      action: "activated",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.updated,
      category: "billing",
      entity: "subscription",
      action: "updated",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.cancelled,
      category: "billing",
      entity: "subscription",
      action: "cancelled",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.paused,
      category: "billing",
      entity: "subscription",
      action: "paused",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.resumed,
      category: "billing",
      entity: "subscription",
      action: "resumed",
    ...
    {
      id: EVENT_REGISTRY.billing.subscription.past_due,
      category: "billing",
      entity: "subscription",
      action: "past_due",
      name: "Subscription Past Due",
      description: "Triggered when a subscription payment is past due",
    },
    {
      id: EVENT_REGISTRY.billing.subscription.trial_started,
      category: "billing",
      entity: "subscription",
      action: "trial_started",
      name: "Trial Started",
      description: "Triggered when a trial period starts",
    },
    {
      id: EVENT_REGISTRY.billing.subscription.trial_ended,
      category: "billing",
      entity: "subscription",
      action: "trial_ended",
      name: "Trial Ended",
      description: "Triggered when a trial period ends",
    },
    {
      id: EVENT_REGISTRY.billing.subscription.plan_changed,
      category: "billing",
      entity: "subscription",
      action: "plan_changed",
      name: "Plan Changed",
    ...
    {
      id: EVENT_REGISTRY.billing.payment.completed,
      category: "billing",
      entity: "payment",
      action: "completed",
    ...
    {
      id: EVENT_REGISTRY.billing.payment.failed,
      category: "billing",
      entity: "payment",
      action: "failed",
      name: "Payment Failed",
    ...
    {
      id: EVENT_REGISTRY.billing.payment.refunded,
      category: "billing",
      entity: "payment",
      action: "refunded",
    ...
    {
      id: EVENT_REGISTRY.billing.payment.disputed,
      category: "billing",
      entity: "payment",
      action: "disputed",
      name: "Payment Disputed",
      description: "Triggered when a payment is disputed (chargeback)",
    },
    {
      id: EVENT_REGISTRY.billing.invoice.created,
      category: "billing",
      entity: "invoice",
      action: "created",
    ...
    {
      id: EVENT_REGISTRY.billing.invoice.paid,
      category: "billing",
      entity: "invoice",
      action: "paid",
      name: "Invoice Paid",
    ...
    {
      id: EVENT_REGISTRY.billing.invoice.overdue,
      category: "billing",
      entity: "invoice",
      action: "overdue",
    ...
    {
      id: EVENT_REGISTRY.billing.usage.threshold_reached,
      category: "billing",
      entity: "usage",
      action: "threshold_reached",
      name: "Usage Threshold Reached",
      description:
        "Triggered when usage reaches a warning threshold (e.g., 80%)",
    },
    {
      id: EVENT_REGISTRY.billing.usage.limit_exceeded,
      category: "billing",
      entity: "usage",
      action: "limit_exceeded",
      name: "Usage Limit Exceeded",
      description: "Triggered when usage exceeds the plan limit",
    },
    {
      id: EVENT_REGISTRY.billing.usage.overage_incurred,
      category: "billing",
      entity: "usage",
      action: "overage_incurred",
      name: "Overage Incurred",
      description: "Triggered when overage charges are incurred",
    },
    {
      id: EVENT_REGISTRY.billing.customer.created,
      category: "billing",
      entity: "customer",
      action: "created",
      name: "Billing Customer Created",
      description: "Triggered when a Paddle customer is created",
    },
    {
      id: EVENT_REGISTRY.billing.customer.updated,
      category: "billing",
      entity: "customer",
      action: "updated",
      name: "Billing Customer Updated",
      description: "Triggered when a Paddle customer is updated",
    },
  );
  ...
  events.push(
    {
      id: EVENT_REGISTRY.system.webhook.received,
      category: "system",
      entity: "webhook",
      action: "received",
    ...
    {
      id: EVENT_REGISTRY.system.schedule.triggered,
      category: "system",
      entity: "schedule",
      action: "triggered",
      name: "Schedule Triggered",
      description: "Triggered on a scheduled time",
    },
    {
      id: EVENT_REGISTRY.system.module.installed,
      category: "system",
      entity: "module",
      action: "installed",
      name: "Module Installed",
      description: "Triggered when a module is installed",
    },
    {
      id: EVENT_REGISTRY.system.user.created,
      category: "system",
      entity: "user",
      action: "created",
      name: "User Created",
  ...
  events.push(
    {
      id: EVENT_REGISTRY.ai_agent.agent.created,
      category: "ai_agent",
      entity: "agent",
      action: "created",
    ...
    {
      id: EVENT_REGISTRY.ai_agent.agent.updated,
      category: "ai_agent",
      entity: "agent",
      action: "updated",
      name: "AI Agent Updated",
      description: "Triggered when an AI agent is updated",
    },
    {
      id: EVENT_REGISTRY.ai_agent.agent.deleted,
      category: "ai_agent",
      entity: "agent",
      action: "deleted",
      name: "AI Agent Deleted",
      description: "Triggered when an AI agent is deleted",
    },
    {
      id: EVENT_REGISTRY.ai_agent.agent.activated,
      category: "ai_agent",
      entity: "agent",
      action: "activated",
      name: "AI Agent Activated",
      description: "Triggered when an AI agent is activated",
    },
    {
      id: EVENT_REGISTRY.ai_agent.agent.deactivated,
      category: "ai_agent",
      entity: "agent",
      action: "deactivated",
      name: "AI Agent Deactivated",
      description: "Triggered when an AI agent is deactivated",
    },
    {
      id: EVENT_REGISTRY.ai_agent.execution.started,
      category: "ai_agent",
      entity: "execution",
      action: "started",
      name: "Agent Execution Started",
      description: "Triggered when an AI agent starts execution",
    },
    {
      id: EVENT_REGISTRY.ai_agent.execution.completed,
      category: "ai_agent",
      entity: "execution",
      action: "completed",
      name: "Agent Execution Completed",
      description: "Triggered when an AI agent completes execution",
    },
    {
      id: EVENT_REGISTRY.ai_agent.execution.failed,
      category: "ai_agent",
      entity: "execution",
      action: "failed",
      name: "Agent Execution Failed",
      description: "Triggered when an AI agent execution fails",
    },
    {
      id: EVENT_REGISTRY.ai_agent.execution.cancelled,
      category: "ai_agent",
      entity: "execution",
      action: "cancelled",
      name: "Agent Execution Cancelled",
      description: "Triggered when an AI agent execution is cancelled",
    },
    {
      id: EVENT_REGISTRY.ai_agent.execution.waiting_approval,
      category: "ai_agent",
      entity: "execution",
      action: "waiting_approval",
      name: "Agent Waiting for Approval",
      description: "Triggered when an agent is waiting for human approval",
    },
    {
      id: EVENT_REGISTRY.ai_agent.approval.requested,
      category: "ai_agent",
      entity: "approval",
      action: "requested",
      name: "Approval Requested",
      description: "Triggered when an agent requests human approval",
    },
    {
      id: EVENT_REGISTRY.ai_agent.approval.approved,
      category: "ai_agent",
      entity: "approval",
      action: "approved",
      name: "Action Approved",
      description: "Triggered when a pending action is approved",
    },
    {
      id: EVENT_REGISTRY.ai_agent.approval.denied,
      category: "ai_agent",
      entity: "approval",
      action: "denied",
      name: "Action Denied",
      description: "Triggered when a pending action is denied",
    },
    {
      id: EVENT_REGISTRY.ai_agent.approval.expired,
      category: "ai_agent",
      entity: "approval",
      action: "expired",
      name: "Approval Expired",
      description: "Triggered when a pending approval expires",
    },
    {
      id: EVENT_REGISTRY.ai_agent.tool.called,
      category: "ai_agent",
      entity: "tool",
      action: "called",
      name: "Tool Called",
      description: "Triggered when an agent calls a tool",
    },
    {
      id: EVENT_REGISTRY.ai_agent.tool.succeeded,
      category: "ai_agent",
      entity: "tool",
      action: "succeeded",
      name: "Tool Succeeded",
      description: "Triggered when a tool execution succeeds",
    },
    {
      id: EVENT_REGISTRY.ai_agent.tool.failed,
      category: "ai_agent",
      entity: "tool",
      action: "failed",
      name: "Tool Failed",
    ...
    {
      id: EVENT_REGISTRY.ai_agent.memory.stored,
      category: "ai_agent",
      entity: "memory",
      action: "stored",
      name: "Memory Stored",
      description: "Triggered when agent stores a memory",
    },
    {
      id: EVENT_REGISTRY.ai_agent.memory.consolidated,
      category: "ai_agent",
      entity: "memory",
      action: "consolidated",
      name: "Memory Consolidated",
      description: "Triggered when agent memories are consolidated",
    },
  );
  ...
  events.push(
    // Domain Events
    {
      id: EVENT_REGISTRY.domain.domain.registered,
      category: "domain",
      entity: "domain",
      action: "registered",
      name: "Domain Registered",
      description: "Triggered when a new domain is successfully registered",
    },
    {
      id: EVENT_REGISTRY.domain.domain.renewed,
      category: "domain",
      entity: "domain",
      action: "renewed",
      name: "Domain Renewed",
      description: "Triggered when a domain is renewed",
    },
    {
      id: EVENT_REGISTRY.domain.domain.transferred_in,
      category: "domain",
      entity: "domain",
      action: "transferred_in",
      name: "Domain Transferred In",
      description: "Triggered when a domain is transferred into the platform",
    },
    {
      id: EVENT_REGISTRY.domain.domain.transferred_out,
      category: "domain",
      entity: "domain",
      action: "transferred_out",
      name: "Domain Transferred Out",
      description: "Triggered when a domain is transferred out of the platform",
    },
    {
      id: EVENT_REGISTRY.domain.domain.expiring_soon,
      category: "domain",
      entity: "domain",
      action: "expiring_soon",
      name: "Domain Expiring Soon",
      description:
        "Triggered when a domain is approaching expiration (30/14/7 days)",
    },
    {
      id: EVENT_REGISTRY.domain.domain.expired,
      category: "domain",
      entity: "domain",
      action: "expired",
      name: "Domain Expired",
      description: "Triggered when a domain expires",
    },
    {
      id: EVENT_REGISTRY.domain.domain.suspended,
      category: "domain",
      entity: "domain",
      action: "suspended",
      name: "Domain Suspended",
      description: "Triggered when a domain is suspended",
    },
    {
      id: EVENT_REGISTRY.domain.domain.reactivated,
      category: "domain",
      entity: "domain",
      action: "reactivated",
      name: "Domain Reactivated",
      description: "Triggered when a suspended domain is reactivated",
    },
    {
      id: EVENT_REGISTRY.domain.domain.auto_renewed,
      category: "domain",
      entity: "domain",
      action: "auto_renewed",
      name: "Domain Auto-Renewed",
      description: "Triggered when a domain is automatically renewed",
    },
    {
      id: EVENT_REGISTRY.domain.domain.nameservers_changed,
      category: "domain",
      entity: "domain",
      action: "nameservers_changed",
      name: "Nameservers Changed",
      description: "Triggered when domain nameservers are updated",
    },
    // DNS Events
    {
      id: EVENT_REGISTRY.domain.dns.record_created,
      category: "domain",
      entity: "dns",
      action: "record_created",
      name: "DNS Record Created",
      description: "Triggered when a new DNS record is created",
    },
    {
      id: EVENT_REGISTRY.domain.dns.record_updated,
      category: "domain",
      entity: "dns",
      action: "record_updated",
      name: "DNS Record Updated",
      description: "Triggered when a DNS record is updated",
    },
    {
      id: EVENT_REGISTRY.domain.dns.record_deleted,
      category: "domain",
      entity: "dns",
      action: "record_deleted",
      name: "DNS Record Deleted",
      description: "Triggered when a DNS record is deleted",
    },
    {
      id: EVENT_REGISTRY.domain.dns.zone_created,
      category: "domain",
      entity: "dns",
      action: "zone_created",
      name: "DNS Zone Created",
      description: "Triggered when a DNS zone is created",
    },
    {
      id: EVENT_REGISTRY.domain.dns.ssl_provisioned,
      category: "domain",
      entity: "dns",
      action: "ssl_provisioned",
      name: "SSL Certificate Provisioned",
      description: "Triggered when an SSL certificate is provisioned",
    },
    {
      id: EVENT_REGISTRY.domain.dns.propagation_complete,
      category: "domain",
      entity: "dns",
      action: "propagation_complete",
      name: "DNS Propagation Complete",
      description: "Triggered when DNS changes have fully propagated",
    },
    // Email Events
    {
      id: EVENT_REGISTRY.domain.email.subscription_created,
      category: "domain",
      entity: "email",
      action: "subscription_created",
      name: "Email Subscription Created",
      description: "Triggered when a new email subscription is created",
    },
    {
      id: EVENT_REGISTRY.domain.email.subscription_cancelled,
      category: "domain",
      entity: "email",
      action: "subscription_cancelled",
      name: "Email Subscription Cancelled",
      description: "Triggered when an email subscription is cancelled",
    },
    {
      id: EVENT_REGISTRY.domain.email.account_created,
      category: "domain",
      entity: "email",
      action: "account_created",
      name: "Email Account Created",
      description: "Triggered when a new email account is created",
    },
    {
      id: EVENT_REGISTRY.domain.email.account_deleted,
      category: "domain",
      entity: "email",
      action: "account_deleted",
      name: "Email Account Deleted",
      description: "Triggered when an email account is deleted",
    },
    {
      id: EVENT_REGISTRY.domain.email.quota_warning,
      category: "domain",
      entity: "email",
      action: "quota_warning",
      name: "Email Quota Warning",
      description:
        "Triggered when an email account approaches its storage quota",
    },
    // Order Events
    {
      id: EVENT_REGISTRY.domain.order.created,
      category: "domain",
      entity: "order",
      action: "created",
      name: "Domain Order Created",
      description: "Triggered when a new domain order is placed",
    },
    {
      id: EVENT_REGISTRY.domain.order.completed,
      category: "domain",
      entity: "order",
      action: "completed",
      name: "Domain Order Completed",
      description: "Triggered when a domain order is successfully completed",
    },
    {
      id: EVENT_REGISTRY.domain.order.failed,
      category: "domain",
      entity: "order",
      action: "failed",
      name: "Domain Order Failed",
      description: "Triggered when a domain order fails",
    },
    {
      id: EVENT_REGISTRY.domain.order.refunded,
      category: "domain",
      entity: "order",
      action: "refunded",
      name: "Domain Order Refunded",
      description: "Triggered when a domain order is refunded",
    },
    // Transfer Events
    {
      id: EVENT_REGISTRY.domain.transfer.initiated,
      category: "domain",
      entity: "transfer",
      action: "initiated",
      name: "Transfer Initiated",
      description: "Triggered when a domain transfer is initiated",
    },
    {
      id: EVENT_REGISTRY.domain.transfer.auth_required,
      category: "domain",
      entity: "transfer",
      action: "auth_required",
      name: "Transfer Auth Required",
      description: "Triggered when a domain transfer requires authorization",
    },
    {
      id: EVENT_REGISTRY.domain.transfer.approved,
      category: "domain",
      entity: "transfer",
      action: "approved",
      name: "Transfer Approved",
      description: "Triggered when a domain transfer is approved",
    },
    {
      id: EVENT_REGISTRY.domain.transfer.completed,
      category: "domain",
      entity: "transfer",
      action: "completed",
      name: "Transfer Completed",
      description: "Triggered when a domain transfer is successfully completed",
    },
    {
      id: EVENT_REGISTRY.domain.transfer.failed,
      category: "domain",
      entity: "transfer",
      action: "failed",
      name: "Transfer Failed",
      description: "Triggered when a domain transfer fails",
    },
    {
      id: EVENT_REGISTRY.domain.transfer.cancelled,
      category: "domain",
      entity: "transfer",
      action: "cancelled",
      name: "Transfer Cancelled",
      description: "Triggered when a domain transfer is cancelled",
    },
  );
...
export function parseEventType(
  eventType: string,
): { category: string; entity: string; action: string } | null {
