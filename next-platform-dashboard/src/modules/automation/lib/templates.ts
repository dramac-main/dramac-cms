...
import { SYSTEM_WORKFLOW_TEMPLATES } from "./system-templates";
...
export interface WorkflowTemplate {
  ...
  // System template fields (Phase 2 — replaces hardcoded notifications)
  isSystem?: boolean;
...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  // =========================================================
  {
    ...
    description:
      "Automatically welcome new leads with a personalized email and create follow-up tasks",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          mapping: {
            ...
            activity_points:
              '{{trigger.type === "email_open" ? 5 : trigger.type === "meeting" ? 20 : 10}}',
          },
        },
      ...
      },
      {
        ...
        action_config: {
          ...
          fields: {
            lead_score:
              "{{steps.Calculate Score.result.current_score + steps.Calculate Score.result.activity_points}}",
          },
        },
      ...
      },
      {
        ...
        condition_config: {
          ...
          conditions: [
            {
              field: "{{steps.Update Lead Score.contact.lead_score}}",
      ...
      },
      {
        ...
        action_config: {
          channel: "#sales",
          message:
            "🔥 Hot Lead Alert! {{trigger.contact_name}} just hit a lead score of {{steps.Update Lead Score.contact.lead_score}}",
        },
...

  {
    ...
    trigger: {
      type: "event",
      config: {
        event_type: "crm.contact.tag_added",
        filter: { tag: "nurture" },
      },
    },
    steps: [
      ...
      },
      {
        ...
        action_config: {
          title:
            "Review nurture campaign completion for {{trigger.first_name}}",
          contact_id: "{{trigger.id}}",
        },
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          type: "note",
          description:
            "Customer no-showed for appointment on {{trigger.appointment_date}}. Reschedule email sent.",
        },
        name: "Log to CRM",
      },
    ],
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "Get the most out of our platform by completing your profile settings.",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          channel: "#finance",
          message:
            "⚠️ Invoice #{{trigger.invoice_number}} for {{trigger.client_name}} is 14+ days overdue (${{trigger.amount_due}})",
        },
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          type: "note",
          description:
            "Payment received: ${{trigger.amount}} for Invoice #{{trigger.invoice_number}}",
        },
    ...
    steps: [
      {
        ...
        action_config: {
          ...
          description:
            "Lost reason: {{trigger.lost_reason}}\nValue: ${{trigger.deal_value}}",
      ...
      },
      {
        ...
        action_config: {
          channel: "#sales",
          message:
            "📉 Deal Lost: {{trigger.deal_title}} (${{trigger.deal_value}})\nReason: {{trigger.lost_reason}}",
        },
        name: "Notify Team",
      },
    ],
    ...
    steps: [
      ...
      },
      {
        ...
        condition_config: {
          ...
          conditions: [
            {
              field: "{{steps.Check Existing Contact.found}}",
              operator: "equals",
              value: false,
            },
          ],
  ...
  // =========================================================
  {
    ...
    description:
      "When a new order is placed, find or create the customer as a CRM contact and open a deal for the order value",
    category: "E-Commerce",
    icon: "ShoppingCart",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        condition_config: {
          ...
          conditions: [
            {
              field: "{{steps.Find Existing Contact.found}}",
              operator: "equals",
              value: false,
            },
          ],
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "Order #{{trigger.order_number}} from {{trigger.customer_first_name}} {{trigger.customer_last_name}} — ${{trigger.total_amount}}",
          type: "info",
        },
        name: "Notify Team",
      },
  ...
  // =========================================================
  {
    ...
    description:
      "When an order is shipped, send the customer an email with tracking info and log the activity in CRM",
    category: "E-Commerce",
    icon: "Truck",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Tracking: {{trigger.tracking_number}} via {{trigger.carrier}}",
        },
  ...
  // =========================================================
  {
    ...
    description:
      "When a customer accepts a quote, automatically convert it to an order and notify the team",
    category: "E-Commerce",
    icon: "FileCheck",
    complexity: "intermediate",
    estimatedSetupTime: "5 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Quote #{{trigger.quote_number}} was accepted and converted to an order.",
        },
        name: "Log CRM Activity",
      },
      {
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "Quote #{{trigger.quote_number}} from {{trigger.customer_first_name}} {{trigger.customer_last_name}} was accepted and converted to an order.",
          type: "success",
        },
        name: "Notify Team",
      },
  ...
  },
  {
    ...
    description:
      "Automatically send reminders for quotes that have been viewed but not yet accepted",
    category: "E-Commerce",
    icon: "Clock",
    complexity: "advanced",
    estimatedSetupTime: "15 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Automated reminders sent for Quote #{{trigger.quote_number}}. No response yet.",
        },
  ...
  },
  {
    ...
    description:
      "When a quote is rejected, notify the team for review and log the outcome in CRM",
    category: "E-Commerce",
    icon: "XCircle",
    complexity: "simple",
    estimatedSetupTime: "5 minutes",
    ...
    steps: [
      {
        ...
        action_config: {
          ...
          description:
            "Customer rejected the quote. Reason: {{trigger.rejection_reason}}",
        },
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "Quote #{{trigger.quote_number}} was rejected by {{trigger.customer_first_name}} {{trigger.customer_last_name}}. Reason: {{trigger.rejection_reason}}",
          type: "warning",
        },
        name: "Alert Sales Team",
      },
  ...
  // =========================================================
  {
    ...
    description:
      "When a new appointment is booked, find or create the customer in CRM and log the booking as an activity",
    category: "Booking",
    icon: "CalendarPlus",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Appointment scheduled for {{trigger.start_time}} with {{trigger.staff_name}}. Service: {{trigger.service_name}}.",
        },
  ...
  },
  {
    ...
    description:
      "When a booking is cancelled, send a follow-up email offering to reschedule and log it in CRM",
    category: "Booking",
    icon: "CalendarX",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "{{trigger.service_name}} appointment on {{trigger.start_time}} was cancelled. Reason: {{trigger.cancellation_reason}}",
        },
  ...
  },
  {
    ...
    description:
      "When a booking is confirmed, send a confirmation message to the customer via live chat",
    category: "Booking",
    icon: "MessageSquare",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      {
        ...
        action_config: {
          ...
          content:
            "Your appointment for {{trigger.service_name}} on {{trigger.start_time}} has been confirmed! 🎉\n\nProvider: {{trigger.staff_name}}\nDuration: {{trigger.duration}} minutes\n\nWe look forward to seeing you!",
          sender_type: "system",
        },
  ...
  // =========================================================
  {
    ...
    description:
      "When a new chat conversation starts, find or create the visitor as a CRM contact and assign to an agent",
    category: "Customer Success",
    icon: "MessageCircle",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Customer initiated a chat conversation. Page: {{trigger.page_url}}",
        },
  ...
  },
  {
    ...
    description:
      "When a chat is resolved, send a follow-up email asking for feedback and log the resolution in CRM",
    category: "Customer Success",
    icon: "ThumbsUp",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Chat resolved by {{trigger.agent_name}}. Duration: {{trigger.duration_minutes}} minutes. Satisfaction follow-up sent.",
        },
  ...
  // =========================================================
  {
    ...
    description:
      "When inventory drops below threshold, alert the team via Slack, email, and in-app notification",
    category: "E-Commerce",
    icon: "AlertTriangle",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          subject:
            "⚠️ Low Stock: {{trigger.product_name}} ({{trigger.current_quantity}} remaining)",
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "{{trigger.product_name}} ({{trigger.sku}}) has only {{trigger.current_quantity}} units remaining.",
          type: "warning",
        },
  ...
  // =========================================================
  {
    ...
    description:
      "When a refund is processed, update CRM, email the customer, and alert the finance team",
    category: "E-Commerce",
    icon: "RotateCcw",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            "Refund of ${{trigger.refund_amount}} processed for order #{{trigger.order_number}}. Reason: {{trigger.refund_reason}}.",
        },
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "Refund of ${{trigger.refund_amount}} for order #{{trigger.order_number}} has been processed.",
          type: "info",
        },
  ...
  // =========================================================
  {
    ...
    description:
      "When a CRM deal is moved to Won stage, automatically send the associated quote to the customer",
    category: "Lead Management",
    icon: "Trophy",
    complexity: "intermediate",
    estimatedSetupTime: "10 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        action_config: {
          ...
          description:
            'Deal "{{trigger.deal_title}}" was marked as won. Quote has been automatically sent to the customer.',
        },
        name: "Log Activity",
      },
    ],
  ...
  // =========================================================
  {
    ...
    description:
      "When a chat starts from a customer tagged as VIP in CRM, auto-assign to senior agent and notify the team",
    category: "Customer Success",
    icon: "Star",
    complexity: "advanced",
    estimatedSetupTime: "15 minutes",
    ...
    steps: [
      ...
      },
      {
        ...
        condition_config: {
          ...
          conditions: [
            {
              field: "{{steps.Find CRM Contact.tags}}",
              operator: "contains",
              value: "vip",
            },
          ],
      ...
      },
      {
        ...
        action_config: {
          conversation_id: "{{trigger.conversation_id}}",
          content:
            "Welcome back! As a valued customer, you've been connected to our priority support team. How can we help you today?",
          sender_type: "system",
        },
      ...
      },
      {
        ...
        action_config: {
          ...
          message:
            "⭐ VIP customer {{trigger.visitor_name}} ({{trigger.visitor_email}}) has started a chat. Auto-assigned to priority support.",
          type: "warning",
        },
        name: "Alert Team",
      },
...
// ============================================================================
// COMBINED TEMPLATES (user + system)
// ============================================================================

/**
 * All workflow templates including system templates.
 * Use this for the template gallery and search functions.
 */
...
export function getTemplatesByCategory(category?: string): WorkflowTemplate[] {
  if (!category || category === "all") return ALL_WORKFLOW_TEMPLATES;
...
export function getTemplatesByIndustry(industry: string): WorkflowTemplate[] {
  return ALL_WORKFLOW_TEMPLATES.filter((t) => t.industry === industry);
}
...
export function getTemplateCategories(): string[] {
  return [...new Set(ALL_WORKFLOW_TEMPLATES.map((t) => t.category))];
}
...
export function searchTemplates(query: string): WorkflowTemplate[] {
  ...
  return ALL_WORKFLOW_TEMPLATES.filter(
    (t) =>
 ...
 */
export function getTemplatesRequiringConnection(
