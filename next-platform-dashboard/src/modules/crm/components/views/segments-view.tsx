  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Select
        ...
        onValueChange={(val) =>
          onChange(index, { ...filter, operator: val as FilterOperator })
        }
      >
        <SelectTrigger className="w-[140px]">
...
function SegmentDialog({
  ...
  const handleSave = async () => {
    ...
    try {
      if (segment) {
        await updateSegment(siteId, segment.id, {
          name,
          description,
          segment_type: type,
          filters,
        ...
        <div className="space-y-4 py-4">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="What this segment targets..."
              rows={2}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Dynamic segments auto-update based on filters
              </p>
            </div>
            <Select
              value={type}
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        {segment.segment_type === "dynamic" && (
                          ...
                          >
                            <RefreshCw
                              className={`h-4 w-4 mr-2 ${evaluatingId === segment.id ? "animate-spin" : ""}`}
                            />
                            Re-evaluate
                          </DropdownMenuItem>
                        )}
